...
// SoftLayer_Network_Firewall_Update_Request_Employee - The
// SoftLayer_Network_Firewall_Update_Request_Employee data type returns a user object for the SoftLayer
