...
// SoftLayer_Dns_Domain_ResourceRecord_SrvType_Extended is SoftLayer_Dns_Domain_ResourceRecord_SrvType with all maskable types.
type SoftLayer_Dns_Domain_ResourceRecord_SrvType_Extended struct {
...
func (softlayer_dns_domain_resourcerecord_srvtype *SoftLayer_Dns_Domain_ResourceRecord_SrvType_Extended) String() string {
	return "SoftLayer_Dns_Domain_ResourceRecord_SrvType"
}
