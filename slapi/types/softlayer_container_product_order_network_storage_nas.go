...
// SoftLayer_Container_Product_Order_Network_Storage_Nas - This is the datatype that needs to be
// populated and sent to SoftLayer_Product_Order::placeOrder when placing network attached storage
// orders.
