...
// for the resource
func (softlayer_resource_metadata *SoftLayer_Resource_Metadata) GetBackendMacAddresses(ctx *slapi.RequestContext) ([]string, error) {
...
// is located.
func (softlayer_resource_metadata *SoftLayer_Resource_Metadata) GetDatacenter(ctx *slapi.RequestContext) (string, error) {
	var returnValue string
	return returnValue, nil
}
...
// located.
func (softlayer_resource_metadata *SoftLayer_Resource_Metadata) GetDatacenterId(ctx *slapi.RequestContext) (int, error) {
	var returnValue int
	return returnValue, nil
}

// GetDomain - The getDomain method retrieves the hostname for the resource.
func (softlayer_resource_metadata *SoftLayer_Resource_Metadata) GetDomain(ctx *slapi.RequestContext) (string, error) {
	var returnValue string
	return returnValue, nil
}
...
func (softlayer_resource_metadata *SoftLayer_Resource_Metadata) GetFrontendMacAddresses(ctx *slapi.RequestContext) ([]string, error) {
	var returnValue []string
	return returnValue, nil
}
...
// information.
func (softlayer_resource_metadata *SoftLayer_Resource_Metadata) GetFullyQualifiedDomainName(ctx *slapi.RequestContext) (string, error) {
	var returnValue string
	return returnValue, nil
}

// GetHostname - The getHostname method retrieves the hostname for the resource.
func (softlayer_resource_metadata *SoftLayer_Resource_Metadata) GetHostname(ctx *slapi.RequestContext) (string, error) {
	var returnValue string
	return returnValue, nil
}

// GetId - no documentation
func (softlayer_resource_metadata *SoftLayer_Resource_Metadata) GetId(ctx *slapi.RequestContext) (int, error) {
	var returnValue int
	return returnValue, nil
}
...
func (softlayer_resource_metadata *SoftLayer_Resource_Metadata) GetPrimaryBackendIpAddress(ctx *slapi.RequestContext) (string, error) {
	var returnValue string
	return returnValue, nil
}
...
func (softlayer_resource_metadata *SoftLayer_Resource_Metadata) GetPrimaryIpAddress(ctx *slapi.RequestContext) (string, error) {
	var returnValue string
	return returnValue, nil
}
...
// complete.
func (softlayer_resource_metadata *SoftLayer_Resource_Metadata) GetProvisionState(ctx *slapi.RequestContext) (string, error) {
	var returnValue string
	return returnValue, nil
}
...
// router hostname.
func (softlayer_resource_metadata *SoftLayer_Resource_Metadata) GetRouter(ctx *slapi.RequestContext, macAddress string) (string, error) {
	var returnValue string
	return returnValue, nil
}
...
func (softlayer_resource_metadata *SoftLayer_Resource_Metadata) GetServiceResource(ctx *slapi.RequestContext, serviceName string, index int) (string, error) {
	var returnValue string
	return returnValue, nil
}
...
// output format is
func (softlayer_resource_metadata *SoftLayer_Resource_Metadata) GetServiceResources(ctx *slapi.RequestContext) ([]*SoftLayer_Network_Service_Resource, error) {
...
func (softlayer_resource_metadata *SoftLayer_Resource_Metadata) GetTags(ctx *slapi.RequestContext) ([]string, error) {
	var returnValue []string
	return returnValue, nil
}
...
func (softlayer_resource_metadata *SoftLayer_Resource_Metadata) GetUserMetadata(ctx *slapi.RequestContext) (string, error) {
	var returnValue string
	return returnValue, nil
}
...
func (softlayer_resource_metadata *SoftLayer_Resource_Metadata) GetVlanIds(ctx *slapi.RequestContext, macAddress string) ([]int, error) {
	var returnValue []int
	return returnValue, nil
}
...
// provided MAC address associated with the resource. For each return, the native will appear first,
// followed by any trunked VLANs associated with the network component.
func (softlayer_resource_metadata *SoftLayer_Resource_Metadata) GetVlans(ctx *slapi.RequestContext, macAddress string) ([]int, error) {
	var returnValue []int
	return returnValue, nil
}
