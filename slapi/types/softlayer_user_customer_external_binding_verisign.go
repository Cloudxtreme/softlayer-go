...
// is cancelled.
func (softlayer_user_customer_external_binding_verisign *SoftLayer_User_Customer_External_Binding_Verisign) DeleteObject(commonOptions *slapi.CommonOptions) (bool, error) {
...
func (softlayer_user_customer_external_binding_verisign *SoftLayer_User_Customer_External_Binding_Verisign) Disable(commonOptions *slapi.CommonOptions, reason string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// binding.
func (softlayer_user_customer_external_binding_verisign *SoftLayer_User_Customer_External_Binding_Verisign) Enable(commonOptions *slapi.CommonOptions) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_user_customer_external_binding_verisign *SoftLayer_User_Customer_External_Binding_Verisign) GetActivationCodeForMobileClient(commonOptions *slapi.CommonOptions) (string, error) {
	var returnValue string
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_user_customer_external_binding_verisign *SoftLayer_User_Customer_External_Binding_Verisign) GetObject(commonOptions *slapi.CommonOptions) (*SoftLayer_User_Customer_External_Binding_Verisign, error) {
...
func (softlayer_user_customer_external_binding_verisign *SoftLayer_User_Customer_External_Binding_Verisign) Unlock(commonOptions *slapi.CommonOptions, securityCode string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_user_customer_external_binding_verisign *SoftLayer_User_Customer_External_Binding_Verisign) ValidateCredentialId(commonOptions *slapi.CommonOptions, userId int, externalId string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
