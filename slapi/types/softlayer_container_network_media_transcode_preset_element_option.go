...
// SoftLayer_Container_Network_Media_Transcode_Preset_Element_Option - no documentation
...
func (softlayer_container_network_media_transcode_preset_element_option *SoftLayer_Container_Network_Media_Transcode_Preset_Element_Option) String() string {
	return "SoftLayer_Container_Network_Media_Transcode_Preset_Element_Option"
}
