...
func (softlayer_network_monitor *SoftLayer_Network_Monitor) GetIpAddressesByHardware(commonOptions *slapi.CommonOptions, hardware SoftLayer_Hardware, partialIpAddress string) ([]*SoftLayer_Network_Subnet_IpAddress, error) {
...
func (softlayer_network_monitor *SoftLayer_Network_Monitor) GetIpAddressesByVirtualGuest(commonOptions *slapi.CommonOptions, guest SoftLayer_Virtual_Guest, partialIpAddress string) ([]*SoftLayer_Network_Subnet_IpAddress, error) {
	var returnValue []*SoftLayer_Network_Subnet_IpAddress
	return returnValue, nil
}
