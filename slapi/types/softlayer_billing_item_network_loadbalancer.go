...
// SoftLayer_Billing_Item_Network_LoadBalancer - A SoftLayer_Billing_Item_Network_LoadBalancer
// represents the [[SoftLayer_Billing_Item|billing item]] related to a single
