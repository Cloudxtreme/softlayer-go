...
// McAfee_Epolicy_Orchestrator_Version45_Policy_Object - The
// McAfee_Epolicy_Orchestrator_Version45_Policy_Object data type contains the name of a policy that may
