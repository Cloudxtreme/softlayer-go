...
func (softlayer_auxiliary_press_release_about *SoftLayer_Auxiliary_Press_Release_About) GetObject(commonOptions *slapi.CommonOptions) (*SoftLayer_Auxiliary_Press_Release_About, error) {
