...
func (softlayer_network_firewall_accesscontrollist *SoftLayer_Network_Firewall_AccessControlList) GetObject(commonOptions *slapi.CommonOptions) (*SoftLayer_Network_Firewall_AccessControlList, error) {
