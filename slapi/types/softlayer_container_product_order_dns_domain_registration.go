...
type SoftLayer_Container_Product_Order_Dns_Domain_Registration struct {
	...
	DomainRegistrationList []*SoftLayer_Container_Dns_Domain_Registration_List `json:"domainRegistrationList,omitempty"`
	...
	AdministrativeContact *SoftLayer_Container_Dns_Domain_Registration_Contact `json:"administrativeContact,omitempty"`
	...
	BillingContact *SoftLayer_Container_Dns_Domain_Registration_Contact `json:"billingContact,omitempty"`

	// OwnerContact - Owner contact information associated with an registraton or transfer. This is
	// required if registration type is 'new' or 'transfer'.
	OwnerContact *SoftLayer_Container_Dns_Domain_Registration_Contact `json:"ownerContact,omitempty"`

	// TechnicalContact - Technical contact information associated with an registraton or transfer. This is
	// required if registration type is 'new' or 'transfer'.
	TechnicalContact *SoftLayer_Container_Dns_Domain_Registration_Contact `json:"technicalContact,omitempty"`
