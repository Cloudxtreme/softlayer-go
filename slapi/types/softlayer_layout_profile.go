...
func (softlayer_layout_profile *SoftLayer_Layout_Profile) CreateObject(commonOptions *slapi.CommonOptions, templateObject SoftLayer_Layout_Profile) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// DeleteObject - This method deletes an existing layout profile and associated custom preferences
func (softlayer_layout_profile *SoftLayer_Layout_Profile) DeleteObject(commonOptions *slapi.CommonOptions) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// of the object.
func (softlayer_layout_profile *SoftLayer_Layout_Profile) EditObject(commonOptions *slapi.CommonOptions, templateObject SoftLayer_Layout_Profile) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_layout_profile *SoftLayer_Layout_Profile) GetObject(commonOptions *slapi.CommonOptions) (*SoftLayer_Layout_Profile, error) {
...
func (softlayer_layout_profile *SoftLayer_Layout_Profile) ModifyPreference(commonOptions *slapi.CommonOptions, templateObject SoftLayer_Layout_Profile_Preference) (*SoftLayer_Layout_Profile_Preference, error) {
...
func (softlayer_layout_profile *SoftLayer_Layout_Profile) ModifyPreferences(commonOptions *slapi.CommonOptions, layoutPreferenceObjects []SoftLayer_Layout_Profile_Preference) ([]*SoftLayer_Layout_Profile_Preference, error) {
	var returnValue []*SoftLayer_Layout_Profile_Preference
	return returnValue, nil
}
