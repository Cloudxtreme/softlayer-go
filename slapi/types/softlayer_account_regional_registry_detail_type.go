...
// GetAllObjects - <nil>
func (softlayer_account_regional_registry_detail_type *SoftLayer_Account_Regional_Registry_Detail_Type) GetAllObjects(commonOptions *slapi.CommonOptions) ([]*SoftLayer_Account_Regional_Registry_Detail_Type, error) {
	var returnValue []*SoftLayer_Account_Regional_Registry_Detail_Type
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_account_regional_registry_detail_type *SoftLayer_Account_Regional_Registry_Detail_Type) GetObject(commonOptions *slapi.CommonOptions) (*SoftLayer_Account_Regional_Registry_Detail_Type, error) {
	var returnValue *SoftLayer_Account_Regional_Registry_Detail_Type
	return returnValue, nil
}
