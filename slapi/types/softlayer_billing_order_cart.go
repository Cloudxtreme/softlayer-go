...
func (softlayer_billing_order_cart *SoftLayer_Billing_Order_Cart) CreateCart(commonOptions *slapi.CommonOptions, orderData SoftLayer_Container_Product_Order) (int, error) {
	var returnValue int
...
func (softlayer_billing_order_cart *SoftLayer_Billing_Order_Cart) DeleteCart(commonOptions *slapi.CommonOptions) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetCartByCartKey - Retrieve a valid cart record of a SoftLayer order.
func (softlayer_billing_order_cart *SoftLayer_Billing_Order_Cart) GetCartByCartKey(commonOptions *slapi.CommonOptions, cartKey string) (*SoftLayer_Billing_Order_Cart, error) {
	var returnValue *SoftLayer_Billing_Order_Cart
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_billing_order_cart *SoftLayer_Billing_Order_Cart) GetObject(commonOptions *slapi.CommonOptions) (*SoftLayer_Billing_Order_Cart, error) {
	var returnValue *SoftLayer_Billing_Order_Cart
	return returnValue, nil
}

// GetPdf - no documentation
func (softlayer_billing_order_cart *SoftLayer_Billing_Order_Cart) GetPdf(commonOptions *slapi.CommonOptions) (string, error) {
...
func (softlayer_billing_order_cart *SoftLayer_Billing_Order_Cart) GetRecalculatedOrderContainer(commonOptions *slapi.CommonOptions, orderData SoftLayer_Container_Product_Order, orderBeingPlacedFlag bool) (*SoftLayer_Container_Product_Order, error) {
...
func (softlayer_billing_order_cart *SoftLayer_Billing_Order_Cart) UpdateCart(commonOptions *slapi.CommonOptions, orderData SoftLayer_Container_Product_Order) (int, error) {
	var returnValue int
	return returnValue, nil
}
