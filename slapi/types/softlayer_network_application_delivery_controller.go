...
// delivery controller.
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) CreateLiveLoadBalancer(commonOptions *slapi.CommonOptions, loadBalancer SoftLayer_Network_LoadBalancer_VirtualIpAddress) (bool, error) {
...
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) DeleteLiveLoadBalancer(commonOptions *slapi.CommonOptions, loadBalancer SoftLayer_Network_LoadBalancer_VirtualIpAddress) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// are reflected immediately in the application delivery controller.
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) DeleteLiveLoadBalancerService(commonOptions *slapi.CommonOptions, service SoftLayer_Network_LoadBalancer_Service) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) EditObject(commonOptions *slapi.CommonOptions, templateObject SoftLayer_Network_Application_Delivery_Controller) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetBandwidthDataByDate - <nil>
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) GetBandwidthDataByDate(commonOptions *slapi.CommonOptions, startDateTime time.Time, endDateTime time.Time, networkType string) ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
...
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) GetBandwidthImageByDate(commonOptions *slapi.CommonOptions, startDateTime time.Time, endDateTime time.Time, networkType string) (*SoftLayer_Container_Bandwidth_GraphOutputs, error) {
	var returnValue *SoftLayer_Container_Bandwidth_GraphOutputs
	return returnValue, nil
}

// GetCustomBandwidthDataByDate - no documentation
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) GetCustomBandwidthDataByDate(commonOptions *slapi.CommonOptions, graphData SoftLayer_Container_Graph) (*SoftLayer_Container_Graph, error) {
...
// binary image data.
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) GetLiveLoadBalancerServiceGraphImage(commonOptions *slapi.CommonOptions, service SoftLayer_Network_LoadBalancer_Service, graphType string, metric string) (string, error) {
...
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) GetObject(commonOptions *slapi.CommonOptions) (*SoftLayer_Network_Application_Delivery_Controller, error) {
...
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) RestoreBaseConfiguration(commonOptions *slapi.CommonOptions) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// RestoreConfiguration - Restore an application delivery controller's configuration state.
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) RestoreConfiguration(commonOptions *slapi.CommonOptions, configurationHistoryId int) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) SaveCurrentConfiguration(commonOptions *slapi.CommonOptions, notes string) (*SoftLayer_Network_Application_Delivery_Controller_Configuration_History, error) {
...
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) UpdateLiveLoadBalancer(commonOptions *slapi.CommonOptions, loadBalancer SoftLayer_Network_LoadBalancer_VirtualIpAddress) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) UpdateNetScalerLicense(commonOptions *slapi.CommonOptions) (*SoftLayer_Provisioning_Version1_Transaction, error) {
