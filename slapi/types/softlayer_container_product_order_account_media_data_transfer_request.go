...
// SoftLayer_Container_Product_Order_Account_Media_Data_Transfer_Request - This datatype is to be used
// for data transfer requests.
type SoftLayer_Container_Product_Order_Account_Media_Data_Transfer_Request struct {
