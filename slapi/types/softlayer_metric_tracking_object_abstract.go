...
// SoftLayer_Metric_Tracking_Object_Abstract - SoftLayer_Metric_Tracking_Object_Abstract models a
// generic tracking object type. Typically a tracking object with a specific purpose has it's own data
