...
func (softlayer_auxiliary_press_release_media_partner *SoftLayer_Auxiliary_Press_Release_Media_Partner) GetObject(commonOptions *slapi.CommonOptions) (*SoftLayer_Auxiliary_Press_Release_Media_Partner, error) {
