...
func (softlayer_account_contact *SoftLayer_Account_Contact) CreateObject(commonOptions *slapi.CommonOptions, templateObject SoftLayer_Account_Contact) (*SoftLayer_Account_Contact, error) {
	var returnValue *SoftLayer_Account_Contact
	return returnValue, nil
}

// DeleteObject - deleteObject permanently removes an account contact
func (softlayer_account_contact *SoftLayer_Account_Contact) DeleteObject(commonOptions *slapi.CommonOptions) (bool, error) {
...
func (softlayer_account_contact *SoftLayer_Account_Contact) EditObject(commonOptions *slapi.CommonOptions, templateObject SoftLayer_Account_Contact) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_account_contact *SoftLayer_Account_Contact) GetAllContactTypes(commonOptions *slapi.CommonOptions) ([]*SoftLayer_Account_Contact_Type, error) {
	var returnValue []*SoftLayer_Account_Contact_Type
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_account_contact *SoftLayer_Account_Contact) GetObject(commonOptions *slapi.CommonOptions) (*SoftLayer_Account_Contact, error) {
	var returnValue *SoftLayer_Account_Contact
	return returnValue, nil
}
