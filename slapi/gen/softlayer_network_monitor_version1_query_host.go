...
func (softlayer_network_monitor_version1_query_host *SoftLayer_Network_Monitor_Version1_Query_Host) CreateObject(templateObject SoftLayer_Network_Monitor_Version1_Query_Host) (*SoftLayer_Network_Monitor_Version1_Query_Host, error) {
...
func (softlayer_network_monitor_version1_query_host *SoftLayer_Network_Monitor_Version1_Query_Host) CreateObjects(templateObjects []SoftLayer_Network_Monitor_Version1_Query_Host) ([]*SoftLayer_Network_Monitor_Version1_Query_Host, error) {
	var returnValue []*SoftLayer_Network_Monitor_Version1_Query_Host
	return returnValue, nil
}
...
func (softlayer_network_monitor_version1_query_host *SoftLayer_Network_Monitor_Version1_Query_Host) DeleteObject() (bool, error) {
...
// instance of them into this function. The ID on the object must be set.
func (softlayer_network_monitor_version1_query_host *SoftLayer_Network_Monitor_Version1_Query_Host) DeleteObjects(templateObjects []SoftLayer_Network_Monitor_Version1_Query_Host) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_network_monitor_version1_query_host *SoftLayer_Network_Monitor_Version1_Query_Host) EditObject(templateObject SoftLayer_Network_Monitor_Version1_Query_Host) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// edited by passing in a modified version of the object.
func (softlayer_network_monitor_version1_query_host *SoftLayer_Network_Monitor_Version1_Query_Host) EditObjects(templateObjects []SoftLayer_Network_Monitor_Version1_Query_Host) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_network_monitor_version1_query_host *SoftLayer_Network_Monitor_Version1_Query_Host) FindByHardwareId(hardwareId int) ([]*SoftLayer_Network_Monitor_Version1_Query_Host, error) {
	var returnValue []*SoftLayer_Network_Monitor_Version1_Query_Host
	return returnValue, nil
}
...
func (softlayer_network_monitor_version1_query_host *SoftLayer_Network_Monitor_Version1_Query_Host) GetObject() (*SoftLayer_Network_Monitor_Version1_Query_Host, error) {
	var returnValue *SoftLayer_Network_Monitor_Version1_Query_Host
	return returnValue, nil
}
