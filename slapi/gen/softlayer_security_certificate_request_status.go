...
// GetObject - <nil>
func (softlayer_security_certificate_request_status *SoftLayer_Security_Certificate_Request_Status) GetObject() (*SoftLayer_Security_Certificate_Request_Status, error) {
...
func (softlayer_security_certificate_request_status *SoftLayer_Security_Certificate_Request_Status) GetSslRequestStatuses() ([]*SoftLayer_Security_Certificate_Request_Status, error) {
	var returnValue []*SoftLayer_Security_Certificate_Request_Status
	return returnValue, nil
}
