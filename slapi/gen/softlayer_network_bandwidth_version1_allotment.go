...
func (softlayer_network_bandwidth_version1_allotment *SoftLayer_Network_Bandwidth_Version1_Allotment) CreateObject(templateObject SoftLayer_Network_Bandwidth_Version1_Allotment) (bool, error) {
...
func (softlayer_network_bandwidth_version1_allotment *SoftLayer_Network_Bandwidth_Version1_Allotment) EditObject(templateObject SoftLayer_Network_Bandwidth_Version1_Allotment) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// slow at times.
func (softlayer_network_bandwidth_version1_allotment *SoftLayer_Network_Bandwidth_Version1_Allotment) GetBackendBandwidthByHour(date time.Time) ([]*SoftLayer_Container_Network_Bandwidth_Version1_Usage, error) {
...
func (softlayer_network_bandwidth_version1_allotment *SoftLayer_Network_Bandwidth_Version1_Allotment) GetBackendBandwidthUse(startDate time.Time, endDate time.Time) ([]*SoftLayer_Network_Bandwidth_Version1_Usage_Detail, error) {
...
// graphing systems.
func (softlayer_network_bandwidth_version1_allotment *SoftLayer_Network_Bandwidth_Version1_Allotment) GetBandwidthForDateRange(startDate time.Time, endDate time.Time) ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
...
func (softlayer_network_bandwidth_version1_allotment *SoftLayer_Network_Bandwidth_Version1_Allotment) GetBandwidthImage(networkType string, snapshotRange string, draw bool, dateSpecified time.Time) (*SoftLayer_Container_Bandwidth_GraphOutputs, error) {
	var returnValue *SoftLayer_Container_Bandwidth_GraphOutputs
	return returnValue, nil
}

// GetCustomBandwidthDataByDate - no documentation
func (softlayer_network_bandwidth_version1_allotment *SoftLayer_Network_Bandwidth_Version1_Allotment) GetCustomBandwidthDataByDate(graphData SoftLayer_Container_Graph) (*SoftLayer_Container_Graph, error) {
...
func (softlayer_network_bandwidth_version1_allotment *SoftLayer_Network_Bandwidth_Version1_Allotment) GetFrontendBandwidthByHour(date time.Time) ([]*SoftLayer_Container_Network_Bandwidth_Version1_Usage, error) {
	var returnValue []*SoftLayer_Container_Network_Bandwidth_Version1_Usage
	return returnValue, nil
}
...
func (softlayer_network_bandwidth_version1_allotment *SoftLayer_Network_Bandwidth_Version1_Allotment) GetFrontendBandwidthUse(startDate time.Time, endDate time.Time) ([]*SoftLayer_Network_Bandwidth_Version1_Usage_Detail, error) {
	var returnValue []*SoftLayer_Network_Bandwidth_Version1_Usage_Detail
	return returnValue, nil
}
...
func (softlayer_network_bandwidth_version1_allotment *SoftLayer_Network_Bandwidth_Version1_Allotment) GetObject() (*SoftLayer_Network_Bandwidth_Version1_Allotment, error) {
...
func (softlayer_network_bandwidth_version1_allotment *SoftLayer_Network_Bandwidth_Version1_Allotment) New_getBandwidthImage(networkType string, snapshotRange string, draw bool, dateSpecified time.Time) (*SoftLayer_Container_Bandwidth_GraphOutputs, error) {
	var returnValue *SoftLayer_Container_Bandwidth_GraphOutputs
	return returnValue, nil
}
...
func (softlayer_network_bandwidth_version1_allotment *SoftLayer_Network_Bandwidth_Version1_Allotment) ReassignServers(templateObjects []SoftLayer_Hardware, newAllotmentId int) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_network_bandwidth_version1_allotment *SoftLayer_Network_Bandwidth_Version1_Allotment) RequestVdrCancellation() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_network_bandwidth_version1_allotment *SoftLayer_Network_Bandwidth_Version1_Allotment) RequestVdrContentUpdates(hardwareToAdd []SoftLayer_Hardware, hardwareToRemove []SoftLayer_Hardware, cloudsToAdd []SoftLayer_Virtual_Guest, cloudsToRemove []SoftLayer_Virtual_Guest, optionalAllotmentId int, adcToAdd []SoftLayer_Network_Application_Delivery_Controller, adcToRemove []SoftLayer_Network_Application_Delivery_Controller) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// completion.
func (softlayer_network_bandwidth_version1_allotment *SoftLayer_Network_Bandwidth_Version1_Allotment) SetVdrContent(hardware []SoftLayer_Hardware, bareMetalServers []SoftLayer_Hardware, virtualServerInstance []SoftLayer_Virtual_Guest, adc []SoftLayer_Network_Application_Delivery_Controller, optionalAllotmentId int) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// private rack
func (softlayer_network_bandwidth_version1_allotment *SoftLayer_Network_Bandwidth_Version1_Allotment) UnassignServers(templateObjects []SoftLayer_Hardware) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_network_bandwidth_version1_allotment *SoftLayer_Network_Bandwidth_Version1_Allotment) VoidPendingServerMove(id int, type_ string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_network_bandwidth_version1_allotment *SoftLayer_Network_Bandwidth_Version1_Allotment) VoidPendingVdrCancellation() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
