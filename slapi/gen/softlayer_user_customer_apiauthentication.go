...
// EditObject - <nil>
func (softlayer_user_customer_apiauthentication *SoftLayer_User_Customer_ApiAuthentication) EditObject(templateObject SoftLayer_User_Customer_ApiAuthentication) (*SoftLayer_User_Customer_ApiAuthentication, error) {
...
func (softlayer_user_customer_apiauthentication *SoftLayer_User_Customer_ApiAuthentication) GetObject() (*SoftLayer_User_Customer_ApiAuthentication, error) {
	var returnValue *SoftLayer_User_Customer_ApiAuthentication
	return returnValue, nil
}
