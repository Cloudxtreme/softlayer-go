...
// created.
func (softlayer_network_firewall_update_request *SoftLayer_Network_Firewall_Update_Request) CreateObject(templateObject SoftLayer_Network_Firewall_Update_Request) (*SoftLayer_Network_Firewall_Update_Request, error) {
...
func (softlayer_network_firewall_update_request *SoftLayer_Network_Firewall_Update_Request) GetFirewallUpdateRequestRuleAttributes() (*SoftLayer_Container_Utility_Network_Firewall_Rule_Attribute, error) {
...
// ''getFirewallUpdateRequestRuleAttributes'' Get the possible attribute values for a firewall update
// request rule.
func (softlayer_network_firewall_update_request *SoftLayer_Network_Firewall_Update_Request) GetObject() (*SoftLayer_Network_Firewall_Update_Request, error) {
	var returnValue *SoftLayer_Network_Firewall_Update_Request
	return returnValue, nil
}

// UpdateRuleNote - <nil>
func (softlayer_network_firewall_update_request *SoftLayer_Network_Firewall_Update_Request) UpdateRuleNote(fwRule SoftLayer_Network_Component_Firewall_Rule, note string) (bool, error) {
