...
func (softlayer_user_security_question *SoftLayer_User_Security_Question) GetAllObjects() ([]*SoftLayer_User_Security_Question, error) {
...
// to be viewable.
func (softlayer_user_security_question *SoftLayer_User_Security_Question) GetObject() (*SoftLayer_User_Security_Question, error) {
	var returnValue *SoftLayer_User_Security_Question
	return returnValue, nil
}
