...
func (softlayer_network_backbone *SoftLayer_Network_Backbone) GetAllBackbones() ([]*SoftLayer_Network_Backbone, error) {
...
// name.
func (softlayer_network_backbone *SoftLayer_Network_Backbone) GetBackbonesForLocationName(locationName string) ([]*SoftLayer_Network_Backbone, error) {
	var returnValue []*SoftLayer_Network_Backbone
	return returnValue, nil
}
...
func (softlayer_network_backbone *SoftLayer_Network_Backbone) GetGraphImage() (string, error) {
...
func (softlayer_network_backbone *SoftLayer_Network_Backbone) GetObject() (*SoftLayer_Network_Backbone, error) {
	var returnValue *SoftLayer_Network_Backbone
	return returnValue, nil
}
