...
func (softlayer_auxiliary_marketing_event *SoftLayer_Auxiliary_Marketing_Event) GetMarketingEvents() ([]*SoftLayer_Auxiliary_Marketing_Event, error) {
	var returnValue []*SoftLayer_Auxiliary_Marketing_Event
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_auxiliary_marketing_event *SoftLayer_Auxiliary_Marketing_Event) GetObject() (*SoftLayer_Auxiliary_Marketing_Event, error) {
	var returnValue *SoftLayer_Auxiliary_Marketing_Event
	return returnValue, nil
}
