...
// GetAllObjects - <nil>
func (softlayer_user_customer_mobiledevice_operatingsystem *SoftLayer_User_Customer_MobileDevice_OperatingSystem) GetAllObjects() ([]*SoftLayer_User_Customer_MobileDevice_OperatingSystem, error) {
	var returnValue []*SoftLayer_User_Customer_MobileDevice_OperatingSystem
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_user_customer_mobiledevice_operatingsystem *SoftLayer_User_Customer_MobileDevice_OperatingSystem) GetObject() (*SoftLayer_User_Customer_MobileDevice_OperatingSystem, error) {
	var returnValue *SoftLayer_User_Customer_MobileDevice_OperatingSystem
	return returnValue, nil
}
