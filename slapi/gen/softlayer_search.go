...
func (softlayer_search *SoftLayer_Search) AdvancedSearch(searchString string) ([]*SoftLayer_Container_Search_Result, error) {
...
func (softlayer_search *SoftLayer_Search) GetObjectTypes() ([]*SoftLayer_Container_Search_ObjectType, error) {
...
func (softlayer_search *SoftLayer_Search) Search(searchString string) ([]*SoftLayer_Container_Search_Result, error) {
	var returnValue []*SoftLayer_Container_Search_Result
	return returnValue, nil
}
