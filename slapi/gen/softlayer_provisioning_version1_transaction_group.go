...
// GetAllObjects - <nil>
func (softlayer_provisioning_version1_transaction_group *SoftLayer_Provisioning_Version1_Transaction_Group) GetAllObjects() ([]*SoftLayer_Provisioning_Version1_Transaction_Group, error) {
...
func (softlayer_provisioning_version1_transaction_group *SoftLayer_Provisioning_Version1_Transaction_Group) GetObject() (*SoftLayer_Provisioning_Version1_Transaction_Group, error) {
	var returnValue *SoftLayer_Provisioning_Version1_Transaction_Group
	return returnValue, nil
}
