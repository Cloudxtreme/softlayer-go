...
func (softlayer_dns_secondary *SoftLayer_Dns_Secondary) ConvertToPrimary() (bool, error) {
...
func (softlayer_dns_secondary *SoftLayer_Dns_Secondary) CreateObject(templateObject SoftLayer_Dns_Secondary) (*SoftLayer_Dns_Secondary, error) {
...
func (softlayer_dns_secondary *SoftLayer_Dns_Secondary) CreateObjects(templateObjects []SoftLayer_Dns_Secondary) ([]*SoftLayer_Dns_Secondary, error) {
	var returnValue []*SoftLayer_Dns_Secondary
	return returnValue, nil
}
...
func (softlayer_dns_secondary *SoftLayer_Dns_Secondary) DeleteObject() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// zone name.
func (softlayer_dns_secondary *SoftLayer_Dns_Secondary) EditObject(templateObject SoftLayer_Dns_Secondary) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_dns_secondary *SoftLayer_Dns_Secondary) GetByDomainName(name string) ([]*SoftLayer_Dns_Secondary, error) {
	var returnValue []*SoftLayer_Dns_Secondary
	return returnValue, nil
}
...
func (softlayer_dns_secondary *SoftLayer_Dns_Secondary) GetObject() (*SoftLayer_Dns_Secondary, error) {
	var returnValue *SoftLayer_Dns_Secondary
	return returnValue, nil
}
...
func (softlayer_dns_secondary *SoftLayer_Dns_Secondary) TransferNow() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
