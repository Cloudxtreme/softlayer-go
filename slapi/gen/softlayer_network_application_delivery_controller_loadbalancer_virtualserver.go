...
// DeleteObject - <nil>
func (softlayer_network_application_delivery_controller_loadbalancer_virtualserver *SoftLayer_Network_Application_Delivery_Controller_LoadBalancer_VirtualServer) DeleteObject() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_network_application_delivery_controller_loadbalancer_virtualserver *SoftLayer_Network_Application_Delivery_Controller_LoadBalancer_VirtualServer) GetObject() (*SoftLayer_Network_Application_Delivery_Controller_LoadBalancer_VirtualServer, error) {
...
func (softlayer_network_application_delivery_controller_loadbalancer_virtualserver *SoftLayer_Network_Application_Delivery_Controller_LoadBalancer_VirtualServer) StartSsl() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// StopSsl - Stop SSL acceleration on all SSL virtual services (those with a type of
func (softlayer_network_application_delivery_controller_loadbalancer_virtualserver *SoftLayer_Network_Application_Delivery_Controller_LoadBalancer_VirtualServer) StopSsl() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
