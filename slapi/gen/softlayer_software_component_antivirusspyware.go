...
// GetObject - <nil>
func (softlayer_software_component_antivirusspyware *SoftLayer_Software_Component_AntivirusSpyware) GetObject() (*SoftLayer_Software_Component_AntivirusSpyware, error) {
...
func (softlayer_software_component_antivirusspyware *SoftLayer_Software_Component_AntivirusSpyware) UpdateAntivirusSpywarePolicy(newPolicy string) (bool, error) {
