...
func (softlayer_product_order *SoftLayer_Product_Order) CheckItemAvailability(itemPrices []SoftLayer_Product_Item_Price, accountId int, availabilityTypeKeyNames []string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// CheckItemAvailabilityForImageTemplate - <nil>
func (softlayer_product_order *SoftLayer_Product_Order) CheckItemAvailabilityForImageTemplate(imageTemplateId int, accountId int, packageId int, availabilityTypeKeyNames []string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// CheckItemConflicts - no documentation
func (softlayer_product_order *SoftLayer_Product_Order) CheckItemConflicts(itemPrices []SoftLayer_Product_Item_Price) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_product_order *SoftLayer_Product_Order) GetExternalPaymentAuthorizationReceipt(token string, payerId string) (*SoftLayer_Container_Product_Order_Receipt, error) {
...
func (softlayer_product_order *SoftLayer_Product_Order) GetResellerOrder(orderContainer SoftLayer_Container_Product_Order) (*SoftLayer_Container_Product_Order, error) {
...
// calculations.
func (softlayer_product_order *SoftLayer_Product_Order) GetTaxCalculationResult(orderHash string) (*SoftLayer_Container_Tax_Cache, error) {
...
// parameters.
func (softlayer_product_order *SoftLayer_Product_Order) GetVlans(locationId int, packageId int, selectedItems string, vlanIds []int, subnetIds []int, accountId int) (*SoftLayer_Container_Product_Order_Network_Vlans, error) {
...
func (softlayer_product_order *SoftLayer_Product_Order) PlaceOrder(orderData SoftLayer_Container_Product_Order, saveAsQuote bool) (*SoftLayer_Container_Product_Order_Receipt, error) {
	var returnValue *SoftLayer_Container_Product_Order_Receipt
	return returnValue, nil
}
...
func (softlayer_product_order *SoftLayer_Product_Order) PlaceQuote(orderData SoftLayer_Container_Product_Order) (*SoftLayer_Container_Product_Order_Receipt, error) {
	var returnValue *SoftLayer_Container_Product_Order_Receipt
	return returnValue, nil
}
...
func (softlayer_product_order *SoftLayer_Product_Order) ProcessExternalPaymentAuthorization(token string, payerId string) (*SoftLayer_Container_Product_Order, error) {
	var returnValue *SoftLayer_Container_Product_Order
	return returnValue, nil
}

// RequiredItems - Get list of items that are required with the item prices provided
func (softlayer_product_order *SoftLayer_Product_Order) RequiredItems(itemPrices []SoftLayer_Product_Item_Price) ([]*SoftLayer_Product_Item, error) {
...
// for more details.
func (softlayer_product_order *SoftLayer_Product_Order) VerifyOrder(orderData SoftLayer_Container_Product_Order) (*SoftLayer_Container_Product_Order, error) {
	var returnValue *SoftLayer_Container_Product_Order
	return returnValue, nil
}
