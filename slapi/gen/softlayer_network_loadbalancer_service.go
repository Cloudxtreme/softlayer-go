...
func (softlayer_network_loadbalancer_service *SoftLayer_Network_LoadBalancer_Service) DeleteObject() (bool, error) {
...
func (softlayer_network_loadbalancer_service *SoftLayer_Network_LoadBalancer_Service) GetGraphImage(graphType string, metric string) (string, error) {
...
func (softlayer_network_loadbalancer_service *SoftLayer_Network_LoadBalancer_Service) GetObject() (*SoftLayer_Network_LoadBalancer_Service, error) {
...
func (softlayer_network_loadbalancer_service *SoftLayer_Network_LoadBalancer_Service) GetStatus() ([]*SoftLayer_Container_Network_LoadBalancer_StatusEntry, error) {
...
func (softlayer_network_loadbalancer_service *SoftLayer_Network_LoadBalancer_Service) ResetPeakConnections() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
