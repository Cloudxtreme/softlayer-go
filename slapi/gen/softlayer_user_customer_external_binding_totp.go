...
// Activate - <nil>
func (softlayer_user_customer_external_binding_totp *SoftLayer_User_Customer_External_Binding_Totp) Activate() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// Deactivate - <nil>
func (softlayer_user_customer_external_binding_totp *SoftLayer_User_Customer_External_Binding_Totp) Deactivate() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GenerateSecretKey - <nil>
func (softlayer_user_customer_external_binding_totp *SoftLayer_User_Customer_External_Binding_Totp) GenerateSecretKey() (string, error) {
	var returnValue string
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_user_customer_external_binding_totp *SoftLayer_User_Customer_External_Binding_Totp) GetObject() (*SoftLayer_User_Customer_External_Binding_Totp, error) {
