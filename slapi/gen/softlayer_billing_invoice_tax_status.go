...
// GetAllObjects - <nil>
func (softlayer_billing_invoice_tax_status *SoftLayer_Billing_Invoice_Tax_Status) GetAllObjects() ([]*SoftLayer_Billing_Invoice_Tax_Status, error) {
	var returnValue []*SoftLayer_Billing_Invoice_Tax_Status
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_billing_invoice_tax_status *SoftLayer_Billing_Invoice_Tax_Status) GetObject() (*SoftLayer_Billing_Invoice_Tax_Status, error) {
	var returnValue *SoftLayer_Billing_Invoice_Tax_Status
	return returnValue, nil
}
