...
func (softlayer_network_storage_group *SoftLayer_Network_Storage_Group) AddAllowedHost(allowedHost SoftLayer_Network_Storage_Allowed_Host) (bool, error) {
...
func (softlayer_network_storage_group *SoftLayer_Network_Storage_Group) AttachToVolume(volume SoftLayer_Network_Storage) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// CreateObject - <nil>
func (softlayer_network_storage_group *SoftLayer_Network_Storage_Group) CreateObject(templateObject SoftLayer_Network_Storage_Group) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// DeleteObject - <nil>
func (softlayer_network_storage_group *SoftLayer_Network_Storage_Group) DeleteObject() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// EditObject - <nil>
func (softlayer_network_storage_group *SoftLayer_Network_Storage_Group) EditObject(templateObject SoftLayer_Network_Storage_Group) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetAllObjects - Use this method to retrieve all network storage groups.
func (softlayer_network_storage_group *SoftLayer_Network_Storage_Group) GetAllObjects() ([]*SoftLayer_Network_Storage_Group, error) {
...
func (softlayer_network_storage_group *SoftLayer_Network_Storage_Group) GetNetworkConnectionDetails() (*SoftLayer_Container_Network_Storage_NetworkConnectionInformation, error) {
	var returnValue *SoftLayer_Container_Network_Storage_NetworkConnectionInformation
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_network_storage_group *SoftLayer_Network_Storage_Group) GetObject() (*SoftLayer_Network_Storage_Group, error) {
	var returnValue *SoftLayer_Network_Storage_Group
	return returnValue, nil
}
...
func (softlayer_network_storage_group *SoftLayer_Network_Storage_Group) RemoveAllowedHost(allowedHost SoftLayer_Network_Storage_Allowed_Host) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// objects currently attached to this group.
func (softlayer_network_storage_group *SoftLayer_Network_Storage_Group) RemoveFromVolume(volume SoftLayer_Network_Storage) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
