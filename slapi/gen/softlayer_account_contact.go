...
func (softlayer_account_contact *SoftLayer_Account_Contact) CreateObject(templateObject SoftLayer_Account_Contact) (*SoftLayer_Account_Contact, error) {
	var returnValue *SoftLayer_Account_Contact
	return returnValue, nil
}

// DeleteObject - deleteObject permanently removes an account contact
func (softlayer_account_contact *SoftLayer_Account_Contact) DeleteObject() (bool, error) {
...
func (softlayer_account_contact *SoftLayer_Account_Contact) EditObject(templateObject SoftLayer_Account_Contact) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_account_contact *SoftLayer_Account_Contact) GetAllContactTypes() ([]*SoftLayer_Account_Contact_Type, error) {
	var returnValue []*SoftLayer_Account_Contact_Type
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_account_contact *SoftLayer_Account_Contact) GetObject() (*SoftLayer_Account_Contact, error) {
	var returnValue *SoftLayer_Account_Contact
	return returnValue, nil
}
