...
func (softlayer_locale_timezone *SoftLayer_Locale_Timezone) GetAllObjects() ([]*SoftLayer_Locale_Timezone, error) {
...
func (softlayer_locale_timezone *SoftLayer_Locale_Timezone) GetObject() (*SoftLayer_Locale_Timezone, error) {
	var returnValue *SoftLayer_Locale_Timezone
	return returnValue, nil
}
