...
func (softlayer_account_password *SoftLayer_Account_Password) EditObject(templateObject SoftLayer_Account_Password) (bool, error) {
...
func (softlayer_account_password *SoftLayer_Account_Password) GetObject() (*SoftLayer_Account_Password, error) {
