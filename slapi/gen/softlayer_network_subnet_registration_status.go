...
// GetAllObjects - <nil>
func (softlayer_network_subnet_registration_status *SoftLayer_Network_Subnet_Registration_Status) GetAllObjects() ([]*SoftLayer_Network_Subnet_Registration_Status, error) {
	var returnValue []*SoftLayer_Network_Subnet_Registration_Status
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_network_subnet_registration_status *SoftLayer_Network_Subnet_Registration_Status) GetObject() (*SoftLayer_Network_Subnet_Registration_Status, error) {
	var returnValue *SoftLayer_Network_Subnet_Registration_Status
	return returnValue, nil
}
