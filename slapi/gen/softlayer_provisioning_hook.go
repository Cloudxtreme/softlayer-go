...
// CreateObject - <nil>
func (softlayer_provisioning_hook *SoftLayer_Provisioning_Hook) CreateObject(templateObject SoftLayer_Provisioning_Hook) (*SoftLayer_Provisioning_Hook, error) {
	var returnValue *SoftLayer_Provisioning_Hook
	return returnValue, nil
}

// DeleteObject - <nil>
func (softlayer_provisioning_hook *SoftLayer_Provisioning_Hook) DeleteObject() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// EditObject - <nil>
func (softlayer_provisioning_hook *SoftLayer_Provisioning_Hook) EditObject(templateObject SoftLayer_Provisioning_Hook) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_provisioning_hook *SoftLayer_Provisioning_Hook) GetObject() (*SoftLayer_Provisioning_Hook, error) {
	var returnValue *SoftLayer_Provisioning_Hook
	return returnValue, nil
}
