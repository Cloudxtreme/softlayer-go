...
// delivery controller.
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) CreateLiveLoadBalancer(loadBalancer SoftLayer_Network_LoadBalancer_VirtualIpAddress) (bool, error) {
...
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) DeleteLiveLoadBalancer(loadBalancer SoftLayer_Network_LoadBalancer_VirtualIpAddress) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// are reflected immediately in the application delivery controller.
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) DeleteLiveLoadBalancerService(service SoftLayer_Network_LoadBalancer_Service) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) EditObject(templateObject SoftLayer_Network_Application_Delivery_Controller) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetBandwidthDataByDate - <nil>
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) GetBandwidthDataByDate(startDateTime time.Time, endDateTime time.Time, networkType string) ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
...
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) GetBandwidthImageByDate(startDateTime time.Time, endDateTime time.Time, networkType string) (*SoftLayer_Container_Bandwidth_GraphOutputs, error) {
	var returnValue *SoftLayer_Container_Bandwidth_GraphOutputs
	return returnValue, nil
}

// GetCustomBandwidthDataByDate - no documentation
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) GetCustomBandwidthDataByDate(graphData SoftLayer_Container_Graph) (*SoftLayer_Container_Graph, error) {
...
// binary image data.
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) GetLiveLoadBalancerServiceGraphImage(service SoftLayer_Network_LoadBalancer_Service, graphType string, metric string) (string, error) {
...
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) GetObject() (*SoftLayer_Network_Application_Delivery_Controller, error) {
...
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) RestoreBaseConfiguration() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// RestoreConfiguration - Restore an application delivery controller's configuration state.
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) RestoreConfiguration(configurationHistoryId int) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) SaveCurrentConfiguration(notes string) (*SoftLayer_Network_Application_Delivery_Controller_Configuration_History, error) {
...
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) UpdateLiveLoadBalancer(loadBalancer SoftLayer_Network_LoadBalancer_VirtualIpAddress) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_network_application_delivery_controller *SoftLayer_Network_Application_Delivery_Controller) UpdateNetScalerLicense() (*SoftLayer_Provisioning_Version1_Transaction, error) {
