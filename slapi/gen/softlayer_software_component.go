...
func (softlayer_software_component *SoftLayer_Software_Component) GetLicenseFile() (string, error) {
...
func (softlayer_software_component *SoftLayer_Software_Component) GetObject() (*SoftLayer_Software_Component, error) {
	var returnValue *SoftLayer_Software_Component
	return returnValue, nil
}

// GetVendorSetUpConfiguration - <nil>
func (softlayer_software_component *SoftLayer_Software_Component) GetVendorSetUpConfiguration() (string, error) {
	var returnValue string
	return returnValue, nil
}
