...
func (softlayer_metric_tracking_object *SoftLayer_Metric_Tracking_Object) GetBackboneBandwidthGraph(graphTitle string) (*SoftLayer_Container_Bandwidth_GraphOutputs, error) {
...
// graphing systems.
func (softlayer_metric_tracking_object *SoftLayer_Metric_Tracking_Object) GetBandwidthData(startDateTime time.Time, endDateTime time.Time, type_ string, rollupSeconds int) ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
...
func (softlayer_metric_tracking_object *SoftLayer_Metric_Tracking_Object) GetBandwidthGraph(startDateTime time.Time, endDateTime time.Time, graphType string, fontSize int, graphWidth int, graphHeight int, doNotShowTimeZone bool) (*SoftLayer_Container_Bandwidth_GraphOutputs, error) {
	var returnValue *SoftLayer_Container_Bandwidth_GraphOutputs
	return returnValue, nil
}
...
func (softlayer_metric_tracking_object *SoftLayer_Metric_Tracking_Object) GetBandwidthMinMax() ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
	var returnValue []*SoftLayer_Metric_Tracking_Object_Data
	return returnValue, nil
}
...
func (softlayer_metric_tracking_object *SoftLayer_Metric_Tracking_Object) GetBandwidthTotal(startDateTime time.Time, endDateTime time.Time, direction string, type_ string) (uint64, error) {
...
// tracking object.
func (softlayer_metric_tracking_object *SoftLayer_Metric_Tracking_Object) GetCustomGraphData(graphContainer SoftLayer_Container_Graph) (*SoftLayer_Container_Graph, error) {
...
// do not return null.
func (softlayer_metric_tracking_object *SoftLayer_Metric_Tracking_Object) GetDetailsForDateRange(startDate time.Time, endDate time.Time, graphType []string) ([]*SoftLayer_Container_Metric_Tracking_Object_Details, error) {
	var returnValue []*SoftLayer_Container_Metric_Tracking_Object_Details
	return returnValue, nil
}

// GetGraph - no documentation
func (softlayer_metric_tracking_object *SoftLayer_Metric_Tracking_Object) GetGraph(startDateTime time.Time, endDateTime time.Time, graphType []string) (*SoftLayer_Container_Bandwidth_GraphOutputs, error) {
	var returnValue *SoftLayer_Container_Bandwidth_GraphOutputs
	return returnValue, nil
}
...
// tracking object.
func (softlayer_metric_tracking_object *SoftLayer_Metric_Tracking_Object) GetMetricDataTypes() ([]*SoftLayer_Container_Metric_Data_Type, error) {
...
func (softlayer_metric_tracking_object *SoftLayer_Metric_Tracking_Object) GetObject() (*SoftLayer_Metric_Tracking_Object, error) {
...
func (softlayer_metric_tracking_object *SoftLayer_Metric_Tracking_Object) GetSummary(graphType string) (*SoftLayer_Container_Metric_Tracking_Object_Summary, error) {
...
// provided.
func (softlayer_metric_tracking_object *SoftLayer_Metric_Tracking_Object) GetSummaryData(startDateTime time.Time, endDateTime time.Time, validTypes []SoftLayer_Container_Metric_Data_Type, summaryPeriod int) ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
	var returnValue []*SoftLayer_Metric_Tracking_Object_Data
	return returnValue, nil
}
