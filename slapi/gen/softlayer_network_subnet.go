...
func (softlayer_network_subnet *SoftLayer_Network_Subnet) CreateReverseDomainRecords() (*SoftLayer_Dns_Domain_Reverse, error) {
...
func (softlayer_network_subnet *SoftLayer_Network_Subnet) CreateSubnetRouteUpdateTransaction(newEndPointIpAddress string) (bool, error) {
...
func (softlayer_network_subnet *SoftLayer_Network_Subnet) CreateSwipTransaction() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// EditNote - no documentation
func (softlayer_network_subnet *SoftLayer_Network_Subnet) EditNote(note string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_network_subnet *SoftLayer_Network_Subnet) FindAllSubnetsAndActiveSwipTransactionStatus() ([]*SoftLayer_Network_Subnet, error) {
...
func (softlayer_network_subnet *SoftLayer_Network_Subnet) GetObject() (*SoftLayer_Network_Subnet, error) {
	var returnValue *SoftLayer_Network_Subnet
	return returnValue, nil
}

// GetReverseDomainRecords - Retrieve all reverse DNS records associated with a subnet.
func (softlayer_network_subnet *SoftLayer_Network_Subnet) GetReverseDomainRecords() ([]*SoftLayer_Dns_Domain, error) {
...
func (softlayer_network_subnet *SoftLayer_Network_Subnet) GetRoutableEndpointIpAddresses() ([]*SoftLayer_Network_Subnet_IpAddress, error) {
...
func (softlayer_network_subnet *SoftLayer_Network_Subnet) GetSubnetForIpAddress(ipAddress string) (*SoftLayer_Network_Subnet, error) {
	var returnValue *SoftLayer_Network_Subnet
	return returnValue, nil
}
