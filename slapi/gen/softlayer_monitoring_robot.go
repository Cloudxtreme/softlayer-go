...
func (softlayer_monitoring_robot *SoftLayer_Monitoring_Robot) CheckConnection() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// DeployMonitoringAgents - <nil>
func (softlayer_monitoring_robot *SoftLayer_Monitoring_Robot) DeployMonitoringAgents(configurationTemplateGroup SoftLayer_Monitoring_Agent_Configuration_Template_Group) (*SoftLayer_Provisioning_Version1_Transaction, error) {
...
// monitoring agent.
func (softlayer_monitoring_robot *SoftLayer_Monitoring_Robot) GetAvailableConfigurationGroups() ([]*SoftLayer_Monitoring_Agent_Configuration_Template_Group, error) {
	var returnValue []*SoftLayer_Monitoring_Agent_Configuration_Template_Group
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_monitoring_robot *SoftLayer_Monitoring_Robot) GetObject() (*SoftLayer_Monitoring_Robot, error) {
...
func (softlayer_monitoring_robot *SoftLayer_Monitoring_Robot) ResetStatus() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
