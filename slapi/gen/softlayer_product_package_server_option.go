...
func (softlayer_product_package_server_option *SoftLayer_Product_Package_Server_Option) GetAllOptions() ([]*SoftLayer_Product_Package_Server_Option, error) {
	var returnValue []*SoftLayer_Product_Package_Server_Option
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_product_package_server_option *SoftLayer_Product_Package_Server_Option) GetObject() (*SoftLayer_Product_Package_Server_Option, error) {
	var returnValue *SoftLayer_Product_Package_Server_Option
	return returnValue, nil
}

// GetOptions - This method will grab all the package server options for the specified type.
func (softlayer_product_package_server_option *SoftLayer_Product_Package_Server_Option) GetOptions(type_ string) ([]*SoftLayer_Product_Package_Server_Option, error) {
	var returnValue []*SoftLayer_Product_Package_Server_Option
	return returnValue, nil
}
