...
func (softlayer_billing_order_quote *SoftLayer_Billing_Order_Quote) Claim(quoteKey string, quoteId int) (*SoftLayer_Billing_Order_Quote, error) {
...
// quote of an order.
func (softlayer_billing_order_quote *SoftLayer_Billing_Order_Quote) DeleteQuote() (*SoftLayer_Billing_Order_Quote, error) {
	var returnValue *SoftLayer_Billing_Order_Quote
	return returnValue, nil
}
...
func (softlayer_billing_order_quote *SoftLayer_Billing_Order_Quote) GetObject() (*SoftLayer_Billing_Order_Quote, error) {
	var returnValue *SoftLayer_Billing_Order_Quote
	return returnValue, nil
}
...
func (softlayer_billing_order_quote *SoftLayer_Billing_Order_Quote) GetPdf() (string, error) {
...
func (softlayer_billing_order_quote *SoftLayer_Billing_Order_Quote) GetQuoteByQuoteKey(quoteKey string) (*SoftLayer_Billing_Order_Quote, error) {
	var returnValue *SoftLayer_Billing_Order_Quote
	return returnValue, nil
}
...
func (softlayer_billing_order_quote *SoftLayer_Billing_Order_Quote) GetRecalculatedOrderContainer(orderData SoftLayer_Container_Product_Order, orderBeingPlacedFlag bool) (*SoftLayer_Container_Product_Order, error) {
...
// approval.
func (softlayer_billing_order_quote *SoftLayer_Billing_Order_Quote) PlaceOrder(orderData SoftLayer_Container_Product_Order) (*SoftLayer_Container_Product_Order_Receipt, error) {
...
func (softlayer_billing_order_quote *SoftLayer_Billing_Order_Quote) PlaceQuote(orderData SoftLayer_Container_Product_Order) (*SoftLayer_Container_Product_Order, error) {
	var returnValue *SoftLayer_Container_Product_Order
	return returnValue, nil
}
...
func (softlayer_billing_order_quote *SoftLayer_Billing_Order_Quote) SaveQuote() (*SoftLayer_Billing_Order_Quote, error) {
	var returnValue *SoftLayer_Billing_Order_Quote
	return returnValue, nil
}
...
// webpage that tells us you have finished the process. After this, it will go to sales for final
// approval.
func (softlayer_billing_order_quote *SoftLayer_Billing_Order_Quote) VerifyOrder(orderData SoftLayer_Container_Product_Order) (*SoftLayer_Container_Product_Order, error) {
	var returnValue *SoftLayer_Container_Product_Order
	return returnValue, nil
}
