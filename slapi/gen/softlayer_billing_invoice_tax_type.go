...
// GetAllObjects - <nil>
func (softlayer_billing_invoice_tax_type *SoftLayer_Billing_Invoice_Tax_Type) GetAllObjects() ([]*SoftLayer_Billing_Invoice_Tax_Type, error) {
	var returnValue []*SoftLayer_Billing_Invoice_Tax_Type
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_billing_invoice_tax_type *SoftLayer_Billing_Invoice_Tax_Type) GetObject() (*SoftLayer_Billing_Invoice_Tax_Type, error) {
	var returnValue *SoftLayer_Billing_Invoice_Tax_Type
	return returnValue, nil
}
