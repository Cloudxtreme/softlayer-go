...
func (softlayer_network_subnet_registration_details *SoftLayer_Network_Subnet_Registration_Details) CreateObject(templateObject SoftLayer_Network_Subnet_Registration_Details) (*SoftLayer_Network_Subnet_Registration_Details, error) {
...
// object.
func (softlayer_network_subnet_registration_details *SoftLayer_Network_Subnet_Registration_Details) DeleteObject() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_network_subnet_registration_details *SoftLayer_Network_Subnet_Registration_Details) GetObject() (*SoftLayer_Network_Subnet_Registration_Details, error) {
	var returnValue *SoftLayer_Network_Subnet_Registration_Details
	return returnValue, nil
}
