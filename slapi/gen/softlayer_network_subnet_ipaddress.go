...
func (softlayer_network_subnet_ipaddress *SoftLayer_Network_Subnet_IpAddress) EditObject(templateObject SoftLayer_Network_Subnet_IpAddress) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// EditObjects - This function is used to edit multiple objects at the same time.
func (softlayer_network_subnet_ipaddress *SoftLayer_Network_Subnet_IpAddress) EditObjects(templateObjects []SoftLayer_Network_Subnet_IpAddress) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// FindByIpv4Address - no documentation
func (softlayer_network_subnet_ipaddress *SoftLayer_Network_Subnet_IpAddress) FindByIpv4Address(ipAddress string) (*SoftLayer_Network_Subnet_IpAddress, error) {
	var returnValue *SoftLayer_Network_Subnet_IpAddress
	return returnValue, nil
}

// GetByIpAddress - no documentation
func (softlayer_network_subnet_ipaddress *SoftLayer_Network_Subnet_IpAddress) GetByIpAddress(ipAddress string) (*SoftLayer_Network_Subnet_IpAddress, error) {
	var returnValue *SoftLayer_Network_Subnet_IpAddress
	return returnValue, nil
}
...
func (softlayer_network_subnet_ipaddress *SoftLayer_Network_Subnet_IpAddress) GetObject() (*SoftLayer_Network_Subnet_IpAddress, error) {
	var returnValue *SoftLayer_Network_Subnet_IpAddress
	return returnValue, nil
}
