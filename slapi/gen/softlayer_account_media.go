...
func (softlayer_account_media *SoftLayer_Account_Media) EditObject(templateObject SoftLayer_Account_Media) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetAllMediaTypes - Retrieve a list supported media types for SoftLayer's Data Transfer Service.
func (softlayer_account_media *SoftLayer_Account_Media) GetAllMediaTypes() ([]*SoftLayer_Account_Media_Type, error) {
	var returnValue []*SoftLayer_Account_Media_Type
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_account_media *SoftLayer_Account_Media) GetObject() (*SoftLayer_Account_Media, error) {
...
// not deleted.
func (softlayer_account_media *SoftLayer_Account_Media) RemoveMediaFromList(mediaTemplate SoftLayer_Account_Media) (int, error) {
	var returnValue int
	return returnValue, nil
}
