...
// press releases.
func (softlayer_auxiliary_press_release *SoftLayer_Auxiliary_Press_Release) GetAllObjects() ([]*SoftLayer_Auxiliary_Press_Release, error) {
...
// service.
func (softlayer_auxiliary_press_release *SoftLayer_Auxiliary_Press_Release) GetObject() (*SoftLayer_Auxiliary_Press_Release, error) {
	var returnValue *SoftLayer_Auxiliary_Press_Release
	return returnValue, nil
}
...
func (softlayer_auxiliary_press_release *SoftLayer_Auxiliary_Press_Release) GetRenderedPressRelease() ([]*SoftLayer_Auxiliary_Press_Release, error) {
	var returnValue []*SoftLayer_Auxiliary_Press_Release
	return returnValue, nil
}
...
func (softlayer_auxiliary_press_release *SoftLayer_Auxiliary_Press_Release) GetRenderedPressReleases(resultLimit string, year string) ([]*SoftLayer_Auxiliary_Press_Release, error) {
	var returnValue []*SoftLayer_Auxiliary_Press_Release
	return returnValue, nil
}
...
func (softlayer_auxiliary_press_release *SoftLayer_Auxiliary_Press_Release) GetWebsiteHighlightPressReleases() ([]*SoftLayer_Auxiliary_Press_Release, error) {
	var returnValue []*SoftLayer_Auxiliary_Press_Release
	return returnValue, nil
}
