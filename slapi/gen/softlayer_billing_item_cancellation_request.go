...
// category]] service.
func (softlayer_billing_item_cancellation_request *SoftLayer_Billing_Item_Cancellation_Request) CreateObject(templateObject SoftLayer_Billing_Item_Cancellation_Request) (*SoftLayer_Billing_Item_Cancellation_Request, error) {
...
func (softlayer_billing_item_cancellation_request *SoftLayer_Billing_Item_Cancellation_Request) GetAllCancellationRequests() ([]*SoftLayer_Billing_Item_Cancellation_Request, error) {
	var returnValue []*SoftLayer_Billing_Item_Cancellation_Request
	return returnValue, nil
}
...
func (softlayer_billing_item_cancellation_request *SoftLayer_Billing_Item_Cancellation_Request) GetCancellationCutoffDate(accountId int, categoryCode string) (*time.Time, error) {
...
func (softlayer_billing_item_cancellation_request *SoftLayer_Billing_Item_Cancellation_Request) GetObject() (*SoftLayer_Billing_Item_Cancellation_Request, error) {
	var returnValue *SoftLayer_Billing_Item_Cancellation_Request
	return returnValue, nil
}
...
func (softlayer_billing_item_cancellation_request *SoftLayer_Billing_Item_Cancellation_Request) RemoveCancellationItem(itemId int) (bool, error) {
...
// request.
func (softlayer_billing_item_cancellation_request *SoftLayer_Billing_Item_Cancellation_Request) ValidateBillingItemForCancellation(billingItemId int) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// Void - This method voids a service cancellation request in "Pending" or "Approved" status.
func (softlayer_billing_item_cancellation_request *SoftLayer_Billing_Item_Cancellation_Request) Void(closeRelatedTicketFlag bool) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
