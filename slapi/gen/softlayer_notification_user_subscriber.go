...
// 15
func (softlayer_notification_user_subscriber *SoftLayer_Notification_User_Subscriber) CreateObject(templateObject SoftLayer_Notification_User_Subscriber) (bool, error) {
...
func (softlayer_notification_user_subscriber *SoftLayer_Notification_User_Subscriber) EditObject(templateObject SoftLayer_Notification_User_Subscriber) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_notification_user_subscriber *SoftLayer_Notification_User_Subscriber) GetObject() (*SoftLayer_Notification_User_Subscriber, error) {
