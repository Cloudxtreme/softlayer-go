...
// GetAllObjects - <nil>
func (softlayer_sales_presale_event *SoftLayer_Sales_Presale_Event) GetAllObjects() ([]*SoftLayer_Sales_Presale_Event, error) {
...
func (softlayer_sales_presale_event *SoftLayer_Sales_Presale_Event) GetObject() (*SoftLayer_Sales_Presale_Event, error) {
	var returnValue *SoftLayer_Sales_Presale_Event
	return returnValue, nil
}
