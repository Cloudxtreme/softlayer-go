...
// CreateObject - <nil>
func (softlayer_scale_policy_action_scale *SoftLayer_Scale_Policy_Action_Scale) CreateObject(templateObject SoftLayer_Scale_Policy_Action_Scale) (*SoftLayer_Scale_Policy_Action_Scale, error) {
	var returnValue *SoftLayer_Scale_Policy_Action_Scale
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_scale_policy_action_scale *SoftLayer_Scale_Policy_Action_Scale) GetObject() (*SoftLayer_Scale_Policy_Action_Scale, error) {
	var returnValue *SoftLayer_Scale_Policy_Action_Scale
	return returnValue, nil
}
