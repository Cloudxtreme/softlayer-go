...
// GetAllObjects - <nil>
func (softlayer_dns_domain_registration_status *SoftLayer_Dns_Domain_Registration_Status) GetAllObjects() ([]*SoftLayer_Dns_Domain_Registration_Status, error) {
	var returnValue []*SoftLayer_Dns_Domain_Registration_Status
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_dns_domain_registration_status *SoftLayer_Dns_Domain_Registration_Status) GetObject() (*SoftLayer_Dns_Domain_Registration_Status, error) {
	var returnValue *SoftLayer_Dns_Domain_Registration_Status
	return returnValue, nil
}
