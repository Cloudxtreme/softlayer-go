...
// GetObject - <nil>
func (softlayer_configuration_template_section_definition *SoftLayer_Configuration_Template_Section_Definition) GetObject() (*SoftLayer_Configuration_Template_Section_Definition, error) {
