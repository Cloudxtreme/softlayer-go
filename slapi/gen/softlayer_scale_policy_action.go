...
// DeleteObject - <nil>
func (softlayer_scale_policy_action *SoftLayer_Scale_Policy_Action) DeleteObject() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// EditObject - <nil>
func (softlayer_scale_policy_action *SoftLayer_Scale_Policy_Action) EditObject(templateObject SoftLayer_Scale_Policy_Action) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_scale_policy_action *SoftLayer_Scale_Policy_Action) GetObject() (*SoftLayer_Scale_Policy_Action, error) {
