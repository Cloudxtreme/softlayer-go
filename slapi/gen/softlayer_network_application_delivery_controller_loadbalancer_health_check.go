...
// GetObject - <nil>
func (softlayer_network_application_delivery_controller_loadbalancer_health_check *SoftLayer_Network_Application_Delivery_Controller_LoadBalancer_Health_Check) GetObject() (*SoftLayer_Network_Application_Delivery_Controller_LoadBalancer_Health_Check, error) {
