...
func (softlayer_security_certificate *SoftLayer_Security_Certificate) CreateObject(templateObject SoftLayer_Security_Certificate) (*SoftLayer_Security_Certificate, error) {
...
// associated services.
func (softlayer_security_certificate *SoftLayer_Security_Certificate) DeleteObject() (bool, error) {
...
func (softlayer_security_certificate *SoftLayer_Security_Certificate) EditObject(templateObject SoftLayer_Security_Certificate) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// FindByCommonName - Locate certificates by their common name, traditionally a domain name.
func (softlayer_security_certificate *SoftLayer_Security_Certificate) FindByCommonName(commonName string) ([]*SoftLayer_Security_Certificate, error) {
	var returnValue []*SoftLayer_Security_Certificate
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_security_certificate *SoftLayer_Security_Certificate) GetObject() (*SoftLayer_Security_Certificate, error) {
	var returnValue *SoftLayer_Security_Certificate
	return returnValue, nil
}
...
func (softlayer_security_certificate *SoftLayer_Security_Certificate) GetPemFormat() (string, error) {
