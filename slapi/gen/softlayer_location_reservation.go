...
func (softlayer_location_reservation *SoftLayer_Location_Reservation) GetAccountReservations() ([]*SoftLayer_Location_Reservation, error) {
	var returnValue []*SoftLayer_Location_Reservation
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_location_reservation *SoftLayer_Location_Reservation) GetObject() (*SoftLayer_Location_Reservation, error) {
	var returnValue *SoftLayer_Location_Reservation
	return returnValue, nil
}
