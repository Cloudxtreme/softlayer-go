...
func (softlayer_ticket_survey *SoftLayer_Ticket_Survey) GetPreference() (*SoftLayer_Container_Ticket_Survey_Preference, error) {
...
func (softlayer_ticket_survey *SoftLayer_Ticket_Survey) OptIn() (*SoftLayer_Container_Ticket_Survey_Preference, error) {
	var returnValue *SoftLayer_Container_Ticket_Survey_Preference
	return returnValue, nil
}
...
func (softlayer_ticket_survey *SoftLayer_Ticket_Survey) OptOut() (*SoftLayer_Container_Ticket_Survey_Preference, error) {
	var returnValue *SoftLayer_Container_Ticket_Survey_Preference
	return returnValue, nil
}
