...
// GetAllObjects - <nil>
func (softlayer_user_customer_mobiledevice_type *SoftLayer_User_Customer_MobileDevice_Type) GetAllObjects() ([]*SoftLayer_User_Customer_MobileDevice_Type, error) {
	var returnValue []*SoftLayer_User_Customer_MobileDevice_Type
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_user_customer_mobiledevice_type *SoftLayer_User_Customer_MobileDevice_Type) GetObject() (*SoftLayer_User_Customer_MobileDevice_Type, error) {
	var returnValue *SoftLayer_User_Customer_MobileDevice_Type
	return returnValue, nil
}
