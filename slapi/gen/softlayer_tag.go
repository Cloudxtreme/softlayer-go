...
func (softlayer_tag *SoftLayer_Tag) AutoComplete(tag string) ([]*SoftLayer_Tag, error) {
	var returnValue []*SoftLayer_Tag
	return returnValue, nil
}

// GetAllTagTypes - no documentation
func (softlayer_tag *SoftLayer_Tag) GetAllTagTypes() ([]*SoftLayer_Tag_Type, error) {
	var returnValue []*SoftLayer_Tag_Type
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_tag *SoftLayer_Tag) GetObject() (*SoftLayer_Tag, error) {
	var returnValue *SoftLayer_Tag
	return returnValue, nil
}
...
func (softlayer_tag *SoftLayer_Tag) GetTagByTagName(tagList string) ([]*SoftLayer_Tag, error) {
	var returnValue []*SoftLayer_Tag
	return returnValue, nil
}
...
func (softlayer_tag *SoftLayer_Tag) SetTags(tags string, keyName string, resourceTableId int) (bool, error) {
