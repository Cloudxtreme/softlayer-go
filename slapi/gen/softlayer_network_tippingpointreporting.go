...
func (softlayer_network_tippingpointreporting *SoftLayer_Network_TippingPointReporting) DrillDownAttack(signatureId string, IpAddress string, subnetMask int, timeFrame int, direction string) (*SoftLayer_Container_Network_IntrusionProtection_SubnetReport, error) {
...
func (softlayer_network_tippingpointreporting *SoftLayer_Network_TippingPointReporting) GetMainStatistics(numberOfAttacks int) ([]*SoftLayer_Container_Network_IntrusionProtection_Statistics, error) {
...
func (softlayer_network_tippingpointreporting *SoftLayer_Network_TippingPointReporting) GetReportForIpAddressOrSubnet(IpAddress string, subnetMask int, timeFrame int, orderBy string, orderDirection string) ([]*SoftLayer_Container_Network_IntrusionProtection_SubnetReport, error) {
	var returnValue []*SoftLayer_Container_Network_IntrusionProtection_SubnetReport
	return returnValue, nil
}
...
func (softlayer_network_tippingpointreporting *SoftLayer_Network_TippingPointReporting) GetSubnetReportForEntireAccount(timeFrame int, orderBy string, orderDirection string, returnSubnetGroups bool) ([]*SoftLayer_Container_Network_IntrusionProtection_SubnetReport, error) {
	var returnValue []*SoftLayer_Container_Network_IntrusionProtection_SubnetReport
	return returnValue, nil
}
