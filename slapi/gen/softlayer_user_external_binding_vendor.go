...
// binding.
func (softlayer_user_external_binding_vendor *SoftLayer_User_External_Binding_Vendor) GetAllObjects() ([]*SoftLayer_User_External_Binding_Vendor, error) {
	var returnValue []*SoftLayer_User_External_Binding_Vendor
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_user_external_binding_vendor *SoftLayer_User_External_Binding_Vendor) GetObject() (*SoftLayer_User_External_Binding_Vendor, error) {
	var returnValue *SoftLayer_User_External_Binding_Vendor
	return returnValue, nil
}
