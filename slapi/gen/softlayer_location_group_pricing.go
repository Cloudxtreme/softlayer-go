...
// GetAllObjects - <nil>
func (softlayer_location_group_pricing *SoftLayer_Location_Group_Pricing) GetAllObjects() ([]*SoftLayer_Location_Group, error) {
	var returnValue []*SoftLayer_Location_Group
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_location_group_pricing *SoftLayer_Location_Group_Pricing) GetObject() (*SoftLayer_Location_Group_Pricing, error) {
