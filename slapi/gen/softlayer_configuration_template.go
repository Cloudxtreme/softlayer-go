...
func (softlayer_configuration_template *SoftLayer_Configuration_Template) CopyTemplate(templateObject SoftLayer_Configuration_Template) (*SoftLayer_Configuration_Template, error) {
	var returnValue *SoftLayer_Configuration_Template
	return returnValue, nil
}

// DeleteObject - no documentation
func (softlayer_configuration_template *SoftLayer_Configuration_Template) DeleteObject() (bool, error) {
...
func (softlayer_configuration_template *SoftLayer_Configuration_Template) EditObject(templateObject SoftLayer_Configuration_Template) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetAllObjects - no documentation
func (softlayer_configuration_template *SoftLayer_Configuration_Template) GetAllObjects() ([]*SoftLayer_Configuration_Template, error) {
	var returnValue []*SoftLayer_Configuration_Template
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_configuration_template *SoftLayer_Configuration_Template) GetObject() (*SoftLayer_Configuration_Template, error) {
	var returnValue *SoftLayer_Configuration_Template
	return returnValue, nil
}

// UpdateDefaultValues - no documentation
func (softlayer_configuration_template *SoftLayer_Configuration_Template) UpdateDefaultValues(configurationValues []SoftLayer_Configuration_Template_Section_Definition_Value) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
