...
// created..
func (softlayer_network_firewall_update_request_rule *SoftLayer_Network_Firewall_Update_Request_Rule) CreateObject(templateObject SoftLayer_Network_Firewall_Update_Request_Rule) (*SoftLayer_Network_Firewall_Update_Request_Rule, error) {
...
func (softlayer_network_firewall_update_request_rule *SoftLayer_Network_Firewall_Update_Request_Rule) GetObject() (*SoftLayer_Network_Firewall_Update_Request_Rule, error) {
	var returnValue *SoftLayer_Network_Firewall_Update_Request_Rule
	return returnValue, nil
}
...
func (softlayer_network_firewall_update_request_rule *SoftLayer_Network_Firewall_Update_Request_Rule) ValidateRule(rule SoftLayer_Network_Firewall_Update_Request_Rule, applyToComponentId int, applyToAclId int) error {
	return nil
}
