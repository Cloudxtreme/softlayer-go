...
func (softlayer_network_loadbalancer_virtualipaddress *SoftLayer_Network_LoadBalancer_VirtualIpAddress) Disable() (bool, error) {
...
// the load balancer.
func (softlayer_network_loadbalancer_virtualipaddress *SoftLayer_Network_LoadBalancer_VirtualIpAddress) EditObject(templateObject SoftLayer_Network_LoadBalancer_VirtualIpAddress) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// Enable - Enable a disabled Virtual IP Address, allowing connections back to the IP address.
func (softlayer_network_loadbalancer_virtualipaddress *SoftLayer_Network_LoadBalancer_VirtualIpAddress) Enable() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_network_loadbalancer_virtualipaddress *SoftLayer_Network_LoadBalancer_VirtualIpAddress) GetObject() (*SoftLayer_Network_LoadBalancer_VirtualIpAddress, error) {
...
func (softlayer_network_loadbalancer_virtualipaddress *SoftLayer_Network_LoadBalancer_VirtualIpAddress) KickAllConnections() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_network_loadbalancer_virtualipaddress *SoftLayer_Network_LoadBalancer_VirtualIpAddress) UpgradeConnectionLimit() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
