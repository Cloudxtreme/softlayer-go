...
func (softlayer_brand *SoftLayer_Brand) CreateCustomerAccount(account SoftLayer_Account, bypassDuplicateAccountCheck bool) (*SoftLayer_Account, error) {
	var returnValue *SoftLayer_Account
	return returnValue, nil
}

// CreateObject - no documentation
func (softlayer_brand *SoftLayer_Brand) CreateObject(templateObject SoftLayer_Brand) (*SoftLayer_Brand, error) {
	var returnValue *SoftLayer_Brand
	return returnValue, nil
}

// GetAllTicketSubjects - <nil>
func (softlayer_brand *SoftLayer_Brand) GetAllTicketSubjects(account SoftLayer_Account) ([]*SoftLayer_Ticket_Subject, error) {
...
func (softlayer_brand *SoftLayer_Brand) GetContactInformation() ([]*SoftLayer_Brand_Contact, error) {
	var returnValue []*SoftLayer_Brand_Contact
	return returnValue, nil
}

// GetMerchantName - no documentation
func (softlayer_brand *SoftLayer_Brand) GetMerchantName() (string, error) {
	var returnValue string
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_brand *SoftLayer_Brand) GetObject() (*SoftLayer_Brand, error) {
	var returnValue *SoftLayer_Brand
	return returnValue, nil
}

// GetToken - <nil>
func (softlayer_brand *SoftLayer_Brand) GetToken(userId int) (string, error) {
	var returnValue string
	return returnValue, nil
}
