...
func (softlayer_billing_item_cancellation_reason *SoftLayer_Billing_Item_Cancellation_Reason) GetAllCancellationReasons() ([]*SoftLayer_Billing_Item_Cancellation_Reason, error) {
	var returnValue []*SoftLayer_Billing_Item_Cancellation_Reason
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_billing_item_cancellation_reason *SoftLayer_Billing_Item_Cancellation_Reason) GetObject() (*SoftLayer_Billing_Item_Cancellation_Reason, error) {
	var returnValue *SoftLayer_Billing_Item_Cancellation_Reason
	return returnValue, nil
}
