...
// DeleteObject - <nil>
func (softlayer_scale_asset *SoftLayer_Scale_Asset) DeleteObject() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_scale_asset *SoftLayer_Scale_Asset) GetObject() (*SoftLayer_Scale_Asset, error) {
