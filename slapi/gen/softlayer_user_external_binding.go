...
func (softlayer_user_external_binding *SoftLayer_User_External_Binding) DeleteObject() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_user_external_binding *SoftLayer_User_External_Binding) GetObject() (*SoftLayer_User_External_Binding, error) {
...
func (softlayer_user_external_binding *SoftLayer_User_External_Binding) UpdateNote(text string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
