...
func (softlayer_user_customer_notification_virtual_guest *SoftLayer_User_Customer_Notification_Virtual_Guest) CreateObject(templateObject SoftLayer_User_Customer_Notification_Virtual_Guest) (*SoftLayer_User_Customer_Notification_Virtual_Guest, error) {
...
func (softlayer_user_customer_notification_virtual_guest *SoftLayer_User_Customer_Notification_Virtual_Guest) CreateObjects(templateObjects []SoftLayer_User_Customer_Notification_Virtual_Guest) ([]*SoftLayer_User_Customer_Notification_Virtual_Guest, error) {
	var returnValue []*SoftLayer_User_Customer_Notification_Virtual_Guest
	return returnValue, nil
}
...
func (softlayer_user_customer_notification_virtual_guest *SoftLayer_User_Customer_Notification_Virtual_Guest) DeleteObjects(templateObjects []SoftLayer_User_Customer_Notification_Virtual_Guest) (bool, error) {
...
func (softlayer_user_customer_notification_virtual_guest *SoftLayer_User_Customer_Notification_Virtual_Guest) FindByGuestId(id int) ([]*SoftLayer_User_Customer_Notification_Virtual_Guest, error) {
	var returnValue []*SoftLayer_User_Customer_Notification_Virtual_Guest
	return returnValue, nil
}
...
func (softlayer_user_customer_notification_virtual_guest *SoftLayer_User_Customer_Notification_Virtual_Guest) GetObject() (*SoftLayer_User_Customer_Notification_Virtual_Guest, error) {
	var returnValue *SoftLayer_User_Customer_Notification_Virtual_Guest
	return returnValue, nil
}
