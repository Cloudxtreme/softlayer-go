...
// CreateObject - <nil>
func (softlayer_layout_profile_containers *SoftLayer_Layout_Profile_Containers) CreateObject(templateObject SoftLayer_Layout_Profile_Containers) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// EditObject - <nil>
func (softlayer_layout_profile_containers *SoftLayer_Layout_Profile_Containers) EditObject(templateObject SoftLayer_Layout_Profile_Containers) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_layout_profile_containers *SoftLayer_Layout_Profile_Containers) GetObject() (*SoftLayer_Layout_Profile_Containers, error) {
