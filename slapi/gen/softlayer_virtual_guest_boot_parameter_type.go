...
// GetAllObjects - <nil>
func (softlayer_virtual_guest_boot_parameter_type *SoftLayer_Virtual_Guest_Boot_Parameter_Type) GetAllObjects() ([]*SoftLayer_Virtual_Guest_Boot_Parameter_Type, error) {
	var returnValue []*SoftLayer_Virtual_Guest_Boot_Parameter_Type
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_virtual_guest_boot_parameter_type *SoftLayer_Virtual_Guest_Boot_Parameter_Type) GetObject() (*SoftLayer_Virtual_Guest_Boot_Parameter_Type, error) {
	var returnValue *SoftLayer_Virtual_Guest_Boot_Parameter_Type
	return returnValue, nil
}
