...
func (softlayer_notification_user_subscriber_mobile *SoftLayer_Notification_User_Subscriber_Mobile) ClearSnoozeTimer() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_notification_user_subscriber_mobile *SoftLayer_Notification_User_Subscriber_Mobile) GetObject() (*SoftLayer_Notification_User_Subscriber_Mobile, error) {
	var returnValue *SoftLayer_Notification_User_Subscriber_Mobile
	return returnValue, nil
}

// SetSnoozeTimer - <nil>
func (softlayer_notification_user_subscriber_mobile *SoftLayer_Notification_User_Subscriber_Mobile) SetSnoozeTimer(start int, end int) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
