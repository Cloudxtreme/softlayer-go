...
// the load balancer.
func (softlayer_network_application_delivery_controller_loadbalancer_virtualipaddress *SoftLayer_Network_Application_Delivery_Controller_LoadBalancer_VirtualIpAddress) EditObject(templateObject SoftLayer_Network_Application_Delivery_Controller_LoadBalancer_VirtualIpAddress) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetAvailableSecureTransportProtocols - <nil>
func (softlayer_network_application_delivery_controller_loadbalancer_virtualipaddress *SoftLayer_Network_Application_Delivery_Controller_LoadBalancer_VirtualIpAddress) GetAvailableSecureTransportProtocols() ([]*SoftLayer_Security_SecureTransportProtocol, error) {
	var returnValue []*SoftLayer_Security_SecureTransportProtocol
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_network_application_delivery_controller_loadbalancer_virtualipaddress *SoftLayer_Network_Application_Delivery_Controller_LoadBalancer_VirtualIpAddress) GetObject() (*SoftLayer_Network_Application_Delivery_Controller_LoadBalancer_VirtualIpAddress, error) {
...
func (softlayer_network_application_delivery_controller_loadbalancer_virtualipaddress *SoftLayer_Network_Application_Delivery_Controller_LoadBalancer_VirtualIpAddress) StartSsl() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// StopSsl - Stop SSL acceleration on all SSL virtual services (those with a type of
func (softlayer_network_application_delivery_controller_loadbalancer_virtualipaddress *SoftLayer_Network_Application_Delivery_Controller_LoadBalancer_VirtualIpAddress) StopSsl() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_network_application_delivery_controller_loadbalancer_virtualipaddress *SoftLayer_Network_Application_Delivery_Controller_LoadBalancer_VirtualIpAddress) UpgradeConnectionLimit() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
