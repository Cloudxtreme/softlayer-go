...
func (softlayer_configuration_template_section_definition_group *SoftLayer_Configuration_Template_Section_Definition_Group) GetAllGroups() ([]*SoftLayer_Configuration_Template_Section_Definition_Group, error) {
	var returnValue []*SoftLayer_Configuration_Template_Section_Definition_Group
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_configuration_template_section_definition_group *SoftLayer_Configuration_Template_Section_Definition_Group) GetObject() (*SoftLayer_Configuration_Template_Section_Definition_Group, error) {
	var returnValue *SoftLayer_Configuration_Template_Section_Definition_Group
	return returnValue, nil
}
