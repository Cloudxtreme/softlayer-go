...
func (softlayer_notification *SoftLayer_Notification) GetAllObjects() ([]*SoftLayer_Notification, error) {
	var returnValue []*SoftLayer_Notification
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_notification *SoftLayer_Notification) GetObject() (*SoftLayer_Notification, error) {
	var returnValue *SoftLayer_Notification
	return returnValue, nil
}
