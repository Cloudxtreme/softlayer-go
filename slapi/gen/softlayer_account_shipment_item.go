...
func (softlayer_account_shipment_item *SoftLayer_Account_Shipment_Item) EditObject(templateObject SoftLayer_Account_Shipment_Item) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_account_shipment_item *SoftLayer_Account_Shipment_Item) GetObject() (*SoftLayer_Account_Shipment_Item, error) {
