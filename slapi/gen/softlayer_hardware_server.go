...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) ActivatePrivatePort() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// ActivatePublicPort - no documentation
func (softlayer_hardware_server *SoftLayer_Hardware_Server) ActivatePublicPort() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) BootToRescueLayer() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) CreateFirmwareUpdateTransaction(ipmi int, raidController int, bios int, harddrive int) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) CreateObject(templateObject SoftLayer_Hardware_Server) (*SoftLayer_Hardware_Server, error) {
	var returnValue *SoftLayer_Hardware_Server
	return returnValue, nil
}

// CreatePostSoftwareInstallTransaction - <nil>
func (softlayer_hardware_server *SoftLayer_Hardware_Server) CreatePostSoftwareInstallTransaction(installCodes []string, returnBoolean bool) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// EditObject - no documentation
func (softlayer_hardware_server *SoftLayer_Hardware_Server) EditObject(templateObject SoftLayer_Hardware_Server) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetBackendBandwidthUsage(startDate time.Time, endDate time.Time) ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetBackendBandwidthUse(startDate time.Time, endDate time.Time) ([]*SoftLayer_Network_Bandwidth_Version1_Usage_Detail, error) {
...
// graphing systems.
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetBandwidthForDateRange(startDate time.Time, endDate time.Time) ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
	var returnValue []*SoftLayer_Metric_Tracking_Object_Data
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetBandwidthImage(networkType string, snapshotRange string, draw bool, dateSpecified time.Time) (*SoftLayer_Container_Bandwidth_GraphOutputs, error) {
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetCurrentBenchmarkCertificationResultFile() (string, error) {
	var returnValue string
	return returnValue, nil
}

// GetCustomBandwidthDataByDate - no documentation
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetCustomBandwidthDataByDate(graphData SoftLayer_Container_Graph) (*SoftLayer_Container_Graph, error) {
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetFirewallProtectableSubnets() ([]*SoftLayer_Network_Subnet, error) {
...
// records between a given date range. This method represents the NEW version of
// getFrontendBandwidthUse
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetFrontendBandwidthUsage(startDate time.Time, endDate time.Time) ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
	var returnValue []*SoftLayer_Metric_Tracking_Object_Data
	return returnValue, nil
}
...
// between a given date range.
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetFrontendBandwidthUse(startDate time.Time, endDate time.Time) ([]*SoftLayer_Network_Bandwidth_Version1_Usage_Detail, error) {
	var returnValue []*SoftLayer_Network_Bandwidth_Version1_Usage_Detail
	return returnValue, nil
}

// GetHardwareByIpAddress - Retrieve a server by searching for the primary IP address.
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetHardwareByIpAddress(ipAddress string) (*SoftLayer_Hardware_Server, error) {
	var returnValue *SoftLayer_Hardware_Server
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetItemPricesFromSoftwareDescriptions(softwareDescriptions []SoftLayer_Software_Description, includeTranslationsFlag bool, returnAllPricesFlag bool) ([]*SoftLayer_Product_Item, error) {
...
// server.
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetManagementNetworkComponent() (*SoftLayer_Network_Component, error) {
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetNetworkComponentFirewallProtectableIpAddresses() ([]*SoftLayer_Network_Subnet_IpAddress, error) {
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetObject() (*SoftLayer_Hardware_Server, error) {
	var returnValue *SoftLayer_Hardware_Server
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetPMInfo() ([]*SoftLayer_Container_RemoteManagement_PmInfo, error) {
	var returnValue []*SoftLayer_Container_RemoteManagement_PmInfo
	return returnValue, nil
}

// GetPrimaryDriveSize - <nil>
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetPrimaryDriveSize() (int, error) {
	var returnValue int
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetPrivateBandwidthDataSummary() (*SoftLayer_Container_Network_Bandwidth_Data_Summary, error) {
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetPrivateBandwidthGraphImage(startTime string, endTime string) (string, error) {
	var returnValue string
	return returnValue, nil
}

// GetPrivateNetworkComponent - Retrieve the private network component attached with this server.
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetPrivateNetworkComponent() (*SoftLayer_Network_Component, error) {
	var returnValue *SoftLayer_Network_Component
	return returnValue, nil
}

// GetPrivateVlan - Retrieve the backend for the primary IP address of the server
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetPrivateVlan() (*SoftLayer_Network_Vlan, error) {
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetPrivateVlanByIpAddress(ipAddress string) (*SoftLayer_Network_Vlan, error) {
	var returnValue *SoftLayer_Network_Vlan
	return returnValue, nil
}

// GetProvisionDate - <nil>
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetProvisionDate() (*time.Time, error) {
...
// will use during its billing period based on its current usage. A server's projected bandwidth usage
// increases in accuracy as it progresses through its billing period.
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetPublicBandwidthDataSummary() (*SoftLayer_Container_Network_Bandwidth_Data_Summary, error) {
	var returnValue *SoftLayer_Container_Network_Bandwidth_Data_Summary
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetPublicBandwidthGraphImage(startTime time.Time, endTime time.Time) (string, error) {
	var returnValue string
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetPublicBandwidthTotal(startTime int, endTime int) (uint64, error) {
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetPublicNetworkComponent() (*SoftLayer_Network_Component, error) {
	var returnValue *SoftLayer_Network_Component
	return returnValue, nil
}

// GetPublicVlan - Retrieve the frontend for the primary IP address of the server
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetPublicVlan() (*SoftLayer_Network_Vlan, error) {
	var returnValue *SoftLayer_Network_Vlan
	return returnValue, nil
}

// GetPublicVlanByHostname - Retrieve the frontend network Vlan by searching the hostname of a server
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetPublicVlanByHostname(hostname string) (*SoftLayer_Network_Vlan, error) {
	var returnValue *SoftLayer_Network_Vlan
	return returnValue, nil
}

// GetReverseDomainRecords - Retrieve the reverse domain records associated with this server.
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetReverseDomainRecords() ([]*SoftLayer_Dns_Domain, error) {
...
// seconds. Calls made to getSensorData for the same server within 30 seconds of each other will return
// the same data. Subsequent calls will return new data once the cache expires.
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetSensorData() ([]*SoftLayer_Container_RemoteManagement_SensorReading, error) {
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetSensorDataWithGraphs() (*SoftLayer_Container_RemoteManagement_SensorReadingsWithGraphs, error) {
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetServerDetails() (*SoftLayer_Container_Hardware_Server_Details, error) {
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetServerFanSpeedGraphs() ([]*SoftLayer_Container_RemoteManagement_Graphs_SensorSpeed, error) {
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetServerPowerState() (string, error) {
	var returnValue string
	return returnValue, nil
}
...
// with it.
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetServerTemperatureGraphs() ([]*SoftLayer_Container_RemoteManagement_Graphs_SensorTemperature, error) {
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetValidBlockDeviceTemplateGroups(visibility string) ([]*SoftLayer_Virtual_Guest_Block_Device_Template_Group, error) {
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetWindowsUpdateAvailableUpdates() ([]*SoftLayer_Container_Utility_Microsoft_Windows_UpdateServices_UpdateItem, error) {
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetWindowsUpdateInstalledUpdates() ([]*SoftLayer_Container_Utility_Microsoft_Windows_UpdateServices_UpdateItem, error) {
	var returnValue []*SoftLayer_Container_Utility_Microsoft_Windows_UpdateServices_UpdateItem
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) GetWindowsUpdateStatus() (*SoftLayer_Container_Utility_Microsoft_Windows_UpdateServices_Status, error) {
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) InitiateIderaBareMetalRestore() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) InitiateR1SoftBareMetalRestore() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// ping command.
func (softlayer_hardware_server *SoftLayer_Hardware_Server) IsBackendPingable() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// command.
func (softlayer_hardware_server *SoftLayer_Hardware_Server) IsPingable() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) IsWindowsServer() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// Ping - Issues a ping command to the server and returns the ping response.
func (softlayer_hardware_server *SoftLayer_Hardware_Server) Ping() (string, error) {
	var returnValue string
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) PowerCycle() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// PowerOff - This method will power off the server via the server's remote management card.
func (softlayer_hardware_server *SoftLayer_Hardware_Server) PowerOff() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// successfully in the past 20 minutes, another remote management command (rebootSoft, rebootHard,
// powerOn, powerOff and powerCycle) will not be allowed. This is to avoid any type of server failures.
func (softlayer_hardware_server *SoftLayer_Hardware_Server) PowerOn() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) RebootDefault() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// successfully in the past 20 minutes, another remote management command (rebootSoft, rebootHard,
// powerOn, powerOff and powerCycle) will not be allowed. This is to avoid any type of server failures.
func (softlayer_hardware_server *SoftLayer_Hardware_Server) RebootHard() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) RebootSoft() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) ReloadCurrentOperatingSystemConfiguration(token string) (string, error) {
	var returnValue string
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) ReloadOperatingSystem(token string, config SoftLayer_Container_Hardware_Server_Configuration) (string, error) {
	var returnValue string
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) RunPassmarkCertificationBenchmark() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// Operating System
func (softlayer_hardware_server *SoftLayer_Hardware_Server) SetOperatingSystemPassword(newPassword string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) SetPrivateNetworkInterfaceSpeed(newSpeed int) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// than the max speed of the interface. It will take less than a minute to update the switch port
// speed. The server uplink will not be operational again until the server interface speed is updated.
func (softlayer_hardware_server *SoftLayer_Hardware_Server) SetPublicNetworkInterfaceSpeed(newSpeed int) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// SetUserMetadata - Sets the data that will be written to the configuration drive.
func (softlayer_hardware_server *SoftLayer_Hardware_Server) SetUserMetadata(metadata []string) ([]*SoftLayer_Hardware_Attribute, error) {
	var returnValue []*SoftLayer_Hardware_Attribute
	return returnValue, nil
}

// ShutdownPrivatePort - no documentation
func (softlayer_hardware_server *SoftLayer_Hardware_Server) ShutdownPrivatePort() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// ShutdownPublicPort - no documentation
func (softlayer_hardware_server *SoftLayer_Hardware_Server) ShutdownPublicPort() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_hardware_server *SoftLayer_Hardware_Server) SparePool(action string, newOrder bool) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// ValidatePartitionsForOperatingSystem - Validates a collection of partitions for an operating system
func (softlayer_hardware_server *SoftLayer_Hardware_Server) ValidatePartitionsForOperatingSystem(operatingSystem SoftLayer_Software_Description, partitions []SoftLayer_Hardware_Component_Partition) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
