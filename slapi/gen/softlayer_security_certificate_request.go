...
func (softlayer_security_certificate_request *SoftLayer_Security_Certificate_Request) CancelSslOrder() (bool, error) {
...
// a domain.
func (softlayer_security_certificate_request *SoftLayer_Security_Certificate_Request) GetAdministratorEmailDomains(commonName string) ([]string, error) {
...
// to a domain.
func (softlayer_security_certificate_request *SoftLayer_Security_Certificate_Request) GetAdministratorEmailPrefixes() ([]string, error) {
	var returnValue []string
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_security_certificate_request *SoftLayer_Security_Certificate_Request) GetObject() (*SoftLayer_Security_Certificate_Request, error) {
...
func (softlayer_security_certificate_request *SoftLayer_Security_Certificate_Request) GetPreviousOrderData() (*SoftLayer_Container_Product_Order_Security_Certificate, error) {
	var returnValue *SoftLayer_Container_Product_Order_Security_Certificate
	return returnValue, nil
}

// GetSslCertificateRequests - no documentation
func (softlayer_security_certificate_request *SoftLayer_Security_Certificate_Request) GetSslCertificateRequests(accountId int) ([]*SoftLayer_Security_Certificate_Request, error) {
	var returnValue []*SoftLayer_Security_Certificate_Request
	return returnValue, nil
}
...
func (softlayer_security_certificate_request *SoftLayer_Security_Certificate_Request) ResendEmail(emailType string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// VeriSign]
func (softlayer_security_certificate_request *SoftLayer_Security_Certificate_Request) ValidateCsr(csr string, validityMonths int, itemId int, serverType string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
