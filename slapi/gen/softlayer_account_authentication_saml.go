...
// CreateObject - <nil>
func (softlayer_account_authentication_saml *SoftLayer_Account_Authentication_Saml) CreateObject(templateObject SoftLayer_Account_Authentication_Saml) (*SoftLayer_Account_Authentication_Saml, error) {
	var returnValue *SoftLayer_Account_Authentication_Saml
	return returnValue, nil
}

// DeleteObject - <nil>
func (softlayer_account_authentication_saml *SoftLayer_Account_Authentication_Saml) DeleteObject() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// EditObject - Edit the object by passing in a modified instance of the object
func (softlayer_account_authentication_saml *SoftLayer_Account_Authentication_Saml) EditObject(templateObject SoftLayer_Account_Authentication_Saml) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetMetadata - <nil>
func (softlayer_account_authentication_saml *SoftLayer_Account_Authentication_Saml) GetMetadata() (string, error) {
	var returnValue string
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_account_authentication_saml *SoftLayer_Account_Authentication_Saml) GetObject() (*SoftLayer_Account_Authentication_Saml, error) {
	var returnValue *SoftLayer_Account_Authentication_Saml
	return returnValue, nil
}
