...
// template.
func (softlayer_virtual_guest_block_device_template_group *SoftLayer_Virtual_Guest_Block_Device_Template_Group) AddLocations(locations []SoftLayer_Location) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// CopyToExternalSource - Create a transaction to export/copy a template to an external source.
func (softlayer_virtual_guest_block_device_template_group *SoftLayer_Virtual_Guest_Block_Device_Template_Group) CopyToExternalSource(configuration SoftLayer_Container_Virtual_Guest_Block_Device_Template_Configuration) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_virtual_guest_block_device_template_group *SoftLayer_Virtual_Guest_Block_Device_Template_Group) CreateFromExternalSource(configuration SoftLayer_Container_Virtual_Guest_Block_Device_Template_Configuration) (*SoftLayer_Virtual_Guest_Block_Device_Template_Group, error) {
...
// repository
func (softlayer_virtual_guest_block_device_template_group *SoftLayer_Virtual_Guest_Block_Device_Template_Group) CreatePublicArchiveTransaction(groupName string, summary string, note string, locations []SoftLayer_Location) (int, error) {
	var returnValue int
	return returnValue, nil
}
...
func (softlayer_virtual_guest_block_device_template_group *SoftLayer_Virtual_Guest_Block_Device_Template_Group) DeleteObject() (*SoftLayer_Provisioning_Version1_Transaction, error) {
...
func (softlayer_virtual_guest_block_device_template_group *SoftLayer_Virtual_Guest_Block_Device_Template_Group) DenySharingAccess(accountId int) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_virtual_guest_block_device_template_group *SoftLayer_Virtual_Guest_Block_Device_Template_Group) EditObject(templateObject SoftLayer_Virtual_Guest_Block_Device_Template_Group) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_virtual_guest_block_device_template_group *SoftLayer_Virtual_Guest_Block_Device_Template_Group) GetObject() (*SoftLayer_Virtual_Guest_Block_Device_Template_Group, error) {
	var returnValue *SoftLayer_Virtual_Guest_Block_Device_Template_Group
	return returnValue, nil
}

// GetPublicImages - <nil>
func (softlayer_virtual_guest_block_device_template_group *SoftLayer_Virtual_Guest_Block_Device_Template_Group) GetPublicImages() ([]*SoftLayer_Virtual_Guest_Block_Device_Template_Group, error) {
	var returnValue []*SoftLayer_Virtual_Guest_Block_Device_Template_Group
	return returnValue, nil
}

// GetStorageLocations - no documentation
func (softlayer_virtual_guest_block_device_template_group *SoftLayer_Virtual_Guest_Block_Device_Template_Group) GetStorageLocations() ([]*SoftLayer_Location, error) {
...
func (softlayer_virtual_guest_block_device_template_group *SoftLayer_Virtual_Guest_Block_Device_Template_Group) GetVhdImportSoftwareDescriptions() ([]*SoftLayer_Software_Description, error) {
...
func (softlayer_virtual_guest_block_device_template_group *SoftLayer_Virtual_Guest_Block_Device_Template_Group) PermitSharingAccess(accountId int) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_virtual_guest_block_device_template_group *SoftLayer_Virtual_Guest_Block_Device_Template_Group) RemoveLocations(locations []SoftLayer_Location) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// SetAvailableLocations - Create transaction(s) to set the archived block device available locations
func (softlayer_virtual_guest_block_device_template_group *SoftLayer_Virtual_Guest_Block_Device_Template_Group) SetAvailableLocations(locations []SoftLayer_Location) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// SetTags - no documentation
func (softlayer_virtual_guest_block_device_template_group *SoftLayer_Virtual_Guest_Block_Device_Template_Group) SetTags(tags string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
