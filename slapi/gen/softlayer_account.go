...
// ActivatePartner - <nil>
func (softlayer_account *SoftLayer_Account) ActivatePartner(accountId string, hashCode string) (*SoftLayer_Account, error) {
	var returnValue *SoftLayer_Account
	return returnValue, nil
}

// AddAchInformation - <nil>
func (softlayer_account *SoftLayer_Account) AddAchInformation(achInformation SoftLayer_Container_Billing_Info_Ach) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// AddReferralPartnerPaymentOption - <nil>
func (softlayer_account *SoftLayer_Account) AddReferralPartnerPaymentOption(paymentOption SoftLayer_Container_Referral_Partner_Payment_Option) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) AreVdrUpdatesBlockedForBilling() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) CancelPayPalTransaction(token string, payerId string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) CompletePayPalTransaction(token string, payerId string) (string, error) {
...
func (softlayer_account *SoftLayer_Account) CountHourlyInstances() (int, error) {
	var returnValue int
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) GetAccountBackupHistory(startDate time.Time, endDate time.Time, backupStatus string) ([]*SoftLayer_Container_Network_Storage_Evault_WebCc_JobDetails, error) {
	var returnValue []*SoftLayer_Container_Network_Storage_Evault_WebCc_JobDetails
	return returnValue, nil
}

// GetAccountTraitValue - no documentation
func (softlayer_account *SoftLayer_Account) GetAccountTraitValue(keyName string) (string, error) {
	var returnValue string
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) GetActiveAlarms() ([]*SoftLayer_Container_Monitoring_Alarm_History, error) {
...
func (softlayer_account *SoftLayer_Account) GetActiveOutletPackages() ([]*SoftLayer_Product_Package, error) {
...
func (softlayer_account *SoftLayer_Account) GetActivePackages() ([]*SoftLayer_Product_Package, error) {
	var returnValue []*SoftLayer_Product_Package
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) GetActivePackagesByAttribute(attributeKeyName string) ([]*SoftLayer_Product_Package, error) {
	var returnValue []*SoftLayer_Product_Package
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) GetActivePrivateHostedCloudPackages() ([]*SoftLayer_Product_Package, error) {
	var returnValue []*SoftLayer_Product_Package
	return returnValue, nil
}

// GetAggregatedUptimeGraph - no documentation
func (softlayer_account *SoftLayer_Account) GetAggregatedUptimeGraph(startDate time.Time, endDate time.Time) (*SoftLayer_Container_Graph, error) {
	var returnValue *SoftLayer_Container_Graph
	return returnValue, nil
}

// GetAlternateCreditCardData - <nil>
func (softlayer_account *SoftLayer_Account) GetAlternateCreditCardData() (*SoftLayer_Container_Account_Payment_Method_CreditCard, error) {
...
func (softlayer_account *SoftLayer_Account) GetAttributeByType(attributeType string) (*SoftLayer_Account_Attribute, error) {
	var returnValue *SoftLayer_Account_Attribute
	return returnValue, nil
}

// GetAuxiliaryNotifications - <nil>
func (softlayer_account *SoftLayer_Account) GetAuxiliaryNotifications() ([]*SoftLayer_Container_Utility_Message, error) {
...
// repositories.
func (softlayer_account *SoftLayer_Account) GetAverageArchiveUsageMetricDataByDate(startDateTime time.Time, endDateTime time.Time) (float32, error) {
...
// repositories.
func (softlayer_account *SoftLayer_Account) GetAveragePublicUsageMetricDataByDate(startDateTime time.Time, endDateTime time.Time) (float32, error) {
	var returnValue float32
	return returnValue, nil
}
...
// more detailed graph.
func (softlayer_account *SoftLayer_Account) GetCurrentBackupStatisticsGraph(detailedGraph bool) (*SoftLayer_Container_Account_Graph_Outputs, error) {
	var returnValue *SoftLayer_Container_Account_Graph_Outputs
	return returnValue, nil
}

// GetCurrentTicketStatisticsGraph - <nil>
func (softlayer_account *SoftLayer_Account) GetCurrentTicketStatisticsGraph(detailedGraph bool) (*SoftLayer_Container_Account_Graph_Outputs, error) {
	var returnValue *SoftLayer_Container_Account_Graph_Outputs
	return returnValue, nil
}

// GetCurrentUser - Retrieve the user record of the user calling the SoftLayer
func (softlayer_account *SoftLayer_Account) GetCurrentUser() (*SoftLayer_User_Customer, error) {
...
func (softlayer_account *SoftLayer_Account) GetDiskUsageMetricDataByDate(startDateTime time.Time, endDateTime time.Time) ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
...
// ''dateTime'' property indicates the time that the disk usage data was measured and ''counter''
// property holds the disk usage in bytes.
func (softlayer_account *SoftLayer_Account) GetDiskUsageMetricDataFromLegacyByDate(startDateTime time.Time, endDateTime time.Time) ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
	var returnValue []*SoftLayer_Metric_Tracking_Object_Data
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) GetDiskUsageMetricDataFromMetricTrackingObjectSystemByDate(startDateTime time.Time, endDateTime time.Time) ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
	var returnValue []*SoftLayer_Metric_Tracking_Object_Data
	return returnValue, nil
}
...
// input parameters.
func (softlayer_account *SoftLayer_Account) GetDiskUsageMetricImageByDate(startDateTime time.Time, endDateTime time.Time) (*SoftLayer_Container_Account_Graph_Outputs, error) {
	var returnValue *SoftLayer_Container_Account_Graph_Outputs
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) GetExecutiveSummaryPdf(pdfType string, historicalType string, startDate string, endDate string) (string, error) {
	var returnValue string
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) GetFlexibleCreditProgramInfo(forNextBillCycle bool) (*SoftLayer_Container_Account_Discount_Program, error) {
	var returnValue *SoftLayer_Container_Account_Discount_Program
	return returnValue, nil
}

// GetHistoricalBackupGraph - <nil>
func (softlayer_account *SoftLayer_Account) GetHistoricalBackupGraph(startDate time.Time, endDate time.Time) (*SoftLayer_Container_Account_Graph_Outputs, error) {
	var returnValue *SoftLayer_Container_Account_Graph_Outputs
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) GetHistoricalBandwidthGraph(startDate time.Time, endDate time.Time) (*SoftLayer_Container_Account_Graph_Outputs, error) {
	var returnValue *SoftLayer_Container_Account_Graph_Outputs
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) GetHistoricalTicketGraph(startDate time.Time, endDate time.Time) (*SoftLayer_Container_Account_Graph_Outputs, error) {
	var returnValue *SoftLayer_Container_Account_Graph_Outputs
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) GetHistoricalUptimeGraph(startDate time.Time, endDate time.Time) (*SoftLayer_Container_Account_Graph_Outputs, error) {
	var returnValue *SoftLayer_Container_Account_Graph_Outputs
	return returnValue, nil
}

// GetLargestAllowedSubnetCidr - <nil>
func (softlayer_account *SoftLayer_Account) GetLargestAllowedSubnetCidr(numberOfHosts int, locationId int) (int, error) {
	var returnValue int
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) GetNextInvoiceExcel() (string, error) {
	var returnValue string
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) GetNextInvoicePdf() (string, error) {
	var returnValue string
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) GetNextInvoicePdfDetailed() (string, error) {
	var returnValue string
	return returnValue, nil
}

// GetNextInvoiceZeroFeeItemCounts - <nil>
func (softlayer_account *SoftLayer_Account) GetNextInvoiceZeroFeeItemCounts() ([]*SoftLayer_Container_Product_Item_Category_ZeroFee_Count, error) {
...
func (softlayer_account *SoftLayer_Account) GetObject() (*SoftLayer_Account, error) {
	var returnValue *SoftLayer_Account
	return returnValue, nil
}
...
// request.
func (softlayer_account *SoftLayer_Account) GetPendingCreditCardChangeRequestData() ([]*SoftLayer_Container_Account_Payment_Method_CreditCard, error) {
	var returnValue []*SoftLayer_Container_Account_Payment_Method_CreditCard
	return returnValue, nil
}

// GetReferralPartnerCommissionForecast - <nil>
func (softlayer_account *SoftLayer_Account) GetReferralPartnerCommissionForecast() ([]*SoftLayer_Container_Referral_Partner_Commission, error) {
	var returnValue []*SoftLayer_Container_Referral_Partner_Commission
	return returnValue, nil
}

// GetReferralPartnerCommissionHistory - <nil>
func (softlayer_account *SoftLayer_Account) GetReferralPartnerCommissionHistory() ([]*SoftLayer_Container_Referral_Partner_Commission, error) {
	var returnValue []*SoftLayer_Container_Referral_Partner_Commission
	return returnValue, nil
}

// GetReferralPartnerCommissionPending - <nil>
func (softlayer_account *SoftLayer_Account) GetReferralPartnerCommissionPending() ([]*SoftLayer_Container_Referral_Partner_Commission, error) {
	var returnValue []*SoftLayer_Container_Referral_Partner_Commission
	return returnValue, nil
}
...
// account
func (softlayer_account *SoftLayer_Account) GetSharedBlockDeviceTemplateGroups() ([]*SoftLayer_Virtual_Guest_Block_Device_Template_Group, error) {
...
func (softlayer_account *SoftLayer_Account) GetTechIncubatorProgramInfo(forNextBillCycle bool) (*SoftLayer_Container_Account_Discount_Program, error) {
	var returnValue *SoftLayer_Container_Account_Discount_Program
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) GetValidSecurityCertificateEntries() ([]*SoftLayer_Security_Certificate_Entry, error) {
...
func (softlayer_account *SoftLayer_Account) GetWindowsUpdateStatus() ([]*SoftLayer_Container_Utility_Microsoft_Windows_UpdateServices_Status, error) {
...
// value.
func (softlayer_account *SoftLayer_Account) HasAttribute(attributeType string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// allowed to have.
func (softlayer_account *SoftLayer_Account) HourlyInstanceLimit() (int, error) {
	var returnValue int
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) HourlyServerLimit() (int, error) {
	var returnValue int
	return returnValue, nil
}

// RemoveAlternateCreditCard - <nil>
func (softlayer_account *SoftLayer_Account) RemoveAlternateCreditCard() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) RequestCreditCardChange(request SoftLayer_Billing_Payment_Card_ChangeRequest, vatId string, paymentRoleName string, onlyChangeNicknameFlag string) (*SoftLayer_Billing_Payment_Card_ChangeRequest, error) {
...
func (softlayer_account *SoftLayer_Account) RequestManualPayment(request SoftLayer_Billing_Payment_Card_ManualPayment) (*SoftLayer_Billing_Payment_Card_ManualPayment, error) {
...
// the calling function.
func (softlayer_account *SoftLayer_Account) RequestManualPaymentUsingCreditCardOnFile(amount string, payWithAlternateCardFlag bool, note string) (*SoftLayer_Billing_Payment_Card_ManualPayment, error) {
	var returnValue *SoftLayer_Billing_Payment_Card_ManualPayment
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) SetVlanSpan(enabled bool) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// SwapCreditCards - <nil>
func (softlayer_account *SoftLayer_Account) SwapCreditCards() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// subnet access.
func (softlayer_account *SoftLayer_Account) UpdateVpnUsersForResource(objectId int, objectType string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_account *SoftLayer_Account) ValidateManualPaymentAmount(amount string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
