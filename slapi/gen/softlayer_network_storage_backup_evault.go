...
func (softlayer_network_storage_backup_evault *SoftLayer_Network_Storage_Backup_Evault) DeleteTasks(tasks []int) (bool, error) {
...
func (softlayer_network_storage_backup_evault *SoftLayer_Network_Storage_Backup_Evault) GetHardwareWithEvaultFirst(option string, exactMatch bool, criteria string, mode string) ([]*SoftLayer_Hardware, error) {
...
func (softlayer_network_storage_backup_evault *SoftLayer_Network_Storage_Backup_Evault) GetObject() (*SoftLayer_Network_Storage_Backup_Evault, error) {
	var returnValue *SoftLayer_Network_Storage_Backup_Evault
	return returnValue, nil
}

// GetWebCCAuthenticationDetails - <nil>
func (softlayer_network_storage_backup_evault *SoftLayer_Network_Storage_Backup_Evault) GetWebCCAuthenticationDetails() (*SoftLayer_Container_Network_Storage_Backup_Evault_WebCc_Authentication_Details, error) {
...
func (softlayer_network_storage_backup_evault *SoftLayer_Network_Storage_Backup_Evault) InitiateBareMetalRestore() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// under the account.
func (softlayer_network_storage_backup_evault *SoftLayer_Network_Storage_Backup_Evault) InitiateBareMetalRestoreForServer(hardwareId int) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
