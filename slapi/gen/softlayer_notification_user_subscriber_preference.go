...
func (softlayer_notification_user_subscriber_preference *SoftLayer_Notification_User_Subscriber_Preference) CreateObject(templateObject SoftLayer_Notification_User_Subscriber_Preference) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// EditObjects - <nil>
func (softlayer_notification_user_subscriber_preference *SoftLayer_Notification_User_Subscriber_Preference) EditObjects(templateObjects []SoftLayer_Notification_User_Subscriber_Preference) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_notification_user_subscriber_preference *SoftLayer_Notification_User_Subscriber_Preference) GetObject() (*SoftLayer_Notification_User_Subscriber_Preference, error) {
