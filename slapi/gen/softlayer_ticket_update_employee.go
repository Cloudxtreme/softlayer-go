...
func (softlayer_ticket_update_employee *SoftLayer_Ticket_Update_Employee) AddResponseRating(responseRating int) (bool, error) {
...
func (softlayer_ticket_update_employee *SoftLayer_Ticket_Update_Employee) GetObject() (*SoftLayer_Ticket_Update_Employee, error) {
