...
// is cancelled.
func (softlayer_user_customer_external_binding_verisign *SoftLayer_User_Customer_External_Binding_Verisign) DeleteObject() (bool, error) {
...
func (softlayer_user_customer_external_binding_verisign *SoftLayer_User_Customer_External_Binding_Verisign) Disable(reason string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// binding.
func (softlayer_user_customer_external_binding_verisign *SoftLayer_User_Customer_External_Binding_Verisign) Enable() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_user_customer_external_binding_verisign *SoftLayer_User_Customer_External_Binding_Verisign) GetActivationCodeForMobileClient() (string, error) {
	var returnValue string
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_user_customer_external_binding_verisign *SoftLayer_User_Customer_External_Binding_Verisign) GetObject() (*SoftLayer_User_Customer_External_Binding_Verisign, error) {
...
func (softlayer_user_customer_external_binding_verisign *SoftLayer_User_Customer_External_Binding_Verisign) Unlock(securityCode string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_user_customer_external_binding_verisign *SoftLayer_User_Customer_External_Binding_Verisign) ValidateCredentialId(userId int, externalId string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
