...
func (softlayer_network_vlan *SoftLayer_Network_Vlan) EditObject(templateObject SoftLayer_Network_Vlan) (bool, error) {
...
func (softlayer_network_vlan *SoftLayer_Network_Vlan) GetCancelFailureReasons() ([]string, error) {
...
func (softlayer_network_vlan *SoftLayer_Network_Vlan) GetFirewallProtectableIpAddresses() ([]*SoftLayer_Network_Subnet_IpAddress, error) {
...
func (softlayer_network_vlan *SoftLayer_Network_Vlan) GetFirewallProtectableSubnets() ([]*SoftLayer_Network_Subnet, error) {
...
func (softlayer_network_vlan *SoftLayer_Network_Vlan) GetObject() (*SoftLayer_Network_Vlan, error) {
...
func (softlayer_network_vlan *SoftLayer_Network_Vlan) GetPrivateVlan() (*SoftLayer_Network_Vlan, error) {
	var returnValue *SoftLayer_Network_Vlan
	return returnValue, nil
}

// GetPrivateVlanByIpAddress - Retrieve the private network associated with an IP address.
func (softlayer_network_vlan *SoftLayer_Network_Vlan) GetPrivateVlanByIpAddress(ipAddress string) (*SoftLayer_Network_Vlan, error) {
	var returnValue *SoftLayer_Network_Vlan
	return returnValue, nil
}
...
// it's domain name.
func (softlayer_network_vlan *SoftLayer_Network_Vlan) GetPublicVlanByFqdn(fqdn string) (*SoftLayer_Network_Vlan, error) {
	var returnValue *SoftLayer_Network_Vlan
	return returnValue, nil
}

// GetReverseDomainRecords - Retrieve all reverse DNS records associated with the subnets assigned to a
func (softlayer_network_vlan *SoftLayer_Network_Vlan) GetReverseDomainRecords() ([]*SoftLayer_Dns_Domain, error) {
...
func (softlayer_network_vlan *SoftLayer_Network_Vlan) GetVlanForIpAddress(ipAddress string) (*SoftLayer_Network_Vlan, error) {
	var returnValue *SoftLayer_Network_Vlan
	return returnValue, nil
}
...
func (softlayer_network_vlan *SoftLayer_Network_Vlan) SetTags(tags string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_network_vlan *SoftLayer_Network_Vlan) UpdateFirewallIntraVlanCommunication(enabled bool) error {
	return nil
}
