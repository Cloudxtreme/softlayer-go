...
func (softlayer_user_customer_mobiledevice *SoftLayer_User_Customer_MobileDevice) CreateObject(templateObject SoftLayer_User_Customer_MobileDevice) (*SoftLayer_User_Customer_MobileDevice, error) {
	var returnValue *SoftLayer_User_Customer_MobileDevice
	return returnValue, nil
}

// DeleteObject - no documentation
func (softlayer_user_customer_mobiledevice *SoftLayer_User_Customer_MobileDevice) DeleteObject() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// EditObject - Edit the object by passing in a modified instance of the object
func (softlayer_user_customer_mobiledevice *SoftLayer_User_Customer_MobileDevice) EditObject(templateObject SoftLayer_User_Customer_MobileDevice) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_user_customer_mobiledevice *SoftLayer_User_Customer_MobileDevice) GetObject() (*SoftLayer_User_Customer_MobileDevice, error) {
	var returnValue *SoftLayer_User_Customer_MobileDevice
	return returnValue, nil
}
