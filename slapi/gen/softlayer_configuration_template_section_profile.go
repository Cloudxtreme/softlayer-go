...
// GetObject - <nil>
func (softlayer_configuration_template_section_profile *SoftLayer_Configuration_Template_Section_Profile) GetObject() (*SoftLayer_Configuration_Template_Section_Profile, error) {
