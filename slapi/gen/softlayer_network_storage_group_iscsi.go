...
func (softlayer_network_storage_group_iscsi *SoftLayer_Network_Storage_Group_Iscsi) AddAllowedHost(allowedHost SoftLayer_Network_Storage_Allowed_Host) (bool, error) {
...
func (softlayer_network_storage_group_iscsi *SoftLayer_Network_Storage_Group_Iscsi) AttachToVolume(volume SoftLayer_Network_Storage) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_network_storage_group_iscsi *SoftLayer_Network_Storage_Group_Iscsi) GetObject() (*SoftLayer_Network_Storage_Group_Iscsi, error) {
...
func (softlayer_network_storage_group_iscsi *SoftLayer_Network_Storage_Group_Iscsi) RemoveAllowedHost(allowedHost SoftLayer_Network_Storage_Allowed_Host) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// objects currently attached to this group.
func (softlayer_network_storage_group_iscsi *SoftLayer_Network_Storage_Group_Iscsi) RemoveFromVolume(volume SoftLayer_Network_Storage) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
