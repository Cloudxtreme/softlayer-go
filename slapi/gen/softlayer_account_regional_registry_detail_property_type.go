...
// GetAllObjects - <nil>
func (softlayer_account_regional_registry_detail_property_type *SoftLayer_Account_Regional_Registry_Detail_Property_Type) GetAllObjects() ([]*SoftLayer_Account_Regional_Registry_Detail_Property_Type, error) {
	var returnValue []*SoftLayer_Account_Regional_Registry_Detail_Property_Type
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_account_regional_registry_detail_property_type *SoftLayer_Account_Regional_Registry_Detail_Property_Type) GetObject() (*SoftLayer_Account_Regional_Registry_Detail_Property_Type, error) {
	var returnValue *SoftLayer_Account_Regional_Registry_Detail_Property_Type
	return returnValue, nil
}
