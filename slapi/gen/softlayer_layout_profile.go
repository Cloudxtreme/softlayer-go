...
func (softlayer_layout_profile *SoftLayer_Layout_Profile) CreateObject(templateObject SoftLayer_Layout_Profile) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// DeleteObject - This method deletes an existing layout profile and associated custom preferences
func (softlayer_layout_profile *SoftLayer_Layout_Profile) DeleteObject() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// of the object.
func (softlayer_layout_profile *SoftLayer_Layout_Profile) EditObject(templateObject SoftLayer_Layout_Profile) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_layout_profile *SoftLayer_Layout_Profile) GetObject() (*SoftLayer_Layout_Profile, error) {
...
func (softlayer_layout_profile *SoftLayer_Layout_Profile) ModifyPreference(templateObject SoftLayer_Layout_Profile_Preference) (*SoftLayer_Layout_Profile_Preference, error) {
...
func (softlayer_layout_profile *SoftLayer_Layout_Profile) ModifyPreferences(layoutPreferenceObjects []SoftLayer_Layout_Profile_Preference) ([]*SoftLayer_Layout_Profile_Preference, error) {
	var returnValue []*SoftLayer_Layout_Profile_Preference
	return returnValue, nil
}
