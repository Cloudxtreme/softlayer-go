...
func (softlayer_product_package_server *SoftLayer_Product_Package_Server) GetAllObjects() ([]*SoftLayer_Product_Package_Server, error) {
	var returnValue []*SoftLayer_Product_Package_Server
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_product_package_server *SoftLayer_Product_Package_Server) GetObject() (*SoftLayer_Product_Package_Server, error) {
	var returnValue *SoftLayer_Product_Package_Server
	return returnValue, nil
}
