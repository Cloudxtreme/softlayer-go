...
// GetAllObjects - <nil>
func (softlayer_software_description *SoftLayer_Software_Description) GetAllObjects() ([]*SoftLayer_Software_Description, error) {
	var returnValue []*SoftLayer_Software_Description
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_software_description *SoftLayer_Software_Description) GetObject() (*SoftLayer_Software_Description, error) {
	var returnValue *SoftLayer_Software_Description
	return returnValue, nil
}
