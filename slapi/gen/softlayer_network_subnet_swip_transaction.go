...
func (softlayer_network_subnet_swip_transaction *SoftLayer_Network_Subnet_Swip_Transaction) FindMyTransactions() ([]*SoftLayer_Network_Subnet_Swip_Transaction, error) {
...
// the account.
func (softlayer_network_subnet_swip_transaction *SoftLayer_Network_Subnet_Swip_Transaction) GetObject() (*SoftLayer_Network_Subnet_Swip_Transaction, error) {
	var returnValue *SoftLayer_Network_Subnet_Swip_Transaction
	return returnValue, nil
}
...
func (softlayer_network_subnet_swip_transaction *SoftLayer_Network_Subnet_Swip_Transaction) RemoveAllSubnetSwips() (int, error) {
	var returnValue int
	return returnValue, nil
}
...
func (softlayer_network_subnet_swip_transaction *SoftLayer_Network_Subnet_Swip_Transaction) RemoveSwipData() (bool, error) {
...
// your current data.
func (softlayer_network_subnet_swip_transaction *SoftLayer_Network_Subnet_Swip_Transaction) ResendSwipData() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_network_subnet_swip_transaction *SoftLayer_Network_Subnet_Swip_Transaction) SwipAllSubnets() (int, error) {
	var returnValue int
	return returnValue, nil
}
...
// date.
func (softlayer_network_subnet_swip_transaction *SoftLayer_Network_Subnet_Swip_Transaction) UpdateAllSubnetSwips() (int, error) {
	var returnValue int
	return returnValue, nil
}
