...
// EditObject - <nil>
func (softlayer_network_message_delivery *SoftLayer_Network_Message_Delivery) EditObject(templateObject SoftLayer_Network_Message_Delivery) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_network_message_delivery *SoftLayer_Network_Message_Delivery) GetObject() (*SoftLayer_Network_Message_Delivery, error) {
