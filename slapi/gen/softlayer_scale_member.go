...
// DeleteObject - <nil>
func (softlayer_scale_member *SoftLayer_Scale_Member) DeleteObject() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_scale_member *SoftLayer_Scale_Member) GetObject() (*SoftLayer_Scale_Member, error) {
