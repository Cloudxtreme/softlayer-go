...
// GetObject - <nil>
func (softlayer_configuration_template_section_definition_value *SoftLayer_Configuration_Template_Section_Definition_Value) GetObject() (*SoftLayer_Configuration_Template_Section_Definition_Value, error) {
