...
func (softlayer_survey *SoftLayer_Survey) GetActiveSurveyByType(type_ string) (*SoftLayer_Survey, error) {
...
func (softlayer_survey *SoftLayer_Survey) GetObject() (*SoftLayer_Survey, error) {
	var returnValue *SoftLayer_Survey
	return returnValue, nil
}

// TakeSurvey - no documentation
func (softlayer_survey *SoftLayer_Survey) TakeSurvey(responses []SoftLayer_Survey_Response) (bool, error) {
