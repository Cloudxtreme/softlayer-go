...
func (softlayer_billing_item_cancellation_reason_category *SoftLayer_Billing_Item_Cancellation_Reason_Category) GetAllCancellationReasonCategories() ([]*SoftLayer_Billing_Item_Cancellation_Reason_Category, error) {
	var returnValue []*SoftLayer_Billing_Item_Cancellation_Reason_Category
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_billing_item_cancellation_reason_category *SoftLayer_Billing_Item_Cancellation_Reason_Category) GetObject() (*SoftLayer_Billing_Item_Cancellation_Reason_Category, error) {
	var returnValue *SoftLayer_Billing_Item_Cancellation_Reason_Category
	return returnValue, nil
}
