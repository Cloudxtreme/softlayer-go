...
func (softlayer_ticket_subject *SoftLayer_Ticket_Subject) GetAllObjects() ([]*SoftLayer_Ticket_Subject, error) {
...
func (softlayer_ticket_subject *SoftLayer_Ticket_Subject) GetObject() (*SoftLayer_Ticket_Subject, error) {
	var returnValue *SoftLayer_Ticket_Subject
	return returnValue, nil
}
...
func (softlayer_ticket_subject *SoftLayer_Ticket_Subject) GetTopFiveKnowledgeLayerQuestions() ([]*SoftLayer_Container_KnowledgeLayer_QuestionAnswer, error) {
