...
// GetObject - <nil>
func (softlayer_product_item_price *SoftLayer_Product_Item_Price) GetObject() (*SoftLayer_Product_Item_Price, error) {
...
func (softlayer_product_item_price *SoftLayer_Product_Item_Price) GetUsageRatePrices(location SoftLayer_Location, items []SoftLayer_Product_Item) ([]*SoftLayer_Product_Item_Price, error) {
	var returnValue []*SoftLayer_Product_Item_Price
	return returnValue, nil
}
