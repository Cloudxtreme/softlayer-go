...
func (softlayer_account_shipment_tracking_data *SoftLayer_Account_Shipment_Tracking_Data) CreateObject(templateObject SoftLayer_Account_Shipment_Tracking_Data) (*SoftLayer_Account_Shipment_Tracking_Data, error) {
...
func (softlayer_account_shipment_tracking_data *SoftLayer_Account_Shipment_Tracking_Data) CreateObjects(templateObjects []SoftLayer_Account_Shipment_Tracking_Data) ([]*SoftLayer_Account_Shipment_Tracking_Data, error) {
	var returnValue []*SoftLayer_Account_Shipment_Tracking_Data
	return returnValue, nil
}

// DeleteObject - deleteObject permanently removes a shipment tracking datum (number)
func (softlayer_account_shipment_tracking_data *SoftLayer_Account_Shipment_Tracking_Data) DeleteObject() (bool, error) {
...
func (softlayer_account_shipment_tracking_data *SoftLayer_Account_Shipment_Tracking_Data) EditObject(templateObject SoftLayer_Account_Shipment_Tracking_Data) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_account_shipment_tracking_data *SoftLayer_Account_Shipment_Tracking_Data) GetObject() (*SoftLayer_Account_Shipment_Tracking_Data, error) {
	var returnValue *SoftLayer_Account_Shipment_Tracking_Data
	return returnValue, nil
}
