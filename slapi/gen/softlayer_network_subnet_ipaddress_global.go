...
// GetObject - <nil>
func (softlayer_network_subnet_ipaddress_global *SoftLayer_Network_Subnet_IpAddress_Global) GetObject() (*SoftLayer_Network_Subnet_IpAddress_Global, error) {
...
func (softlayer_network_subnet_ipaddress_global *SoftLayer_Network_Subnet_IpAddress_Global) Route(newEndPointIpAddress string) (*SoftLayer_Provisioning_Version1_Transaction, error) {
...
// router.
func (softlayer_network_subnet_ipaddress_global *SoftLayer_Network_Subnet_IpAddress_Global) Unroute() (*SoftLayer_Provisioning_Version1_Transaction, error) {
	var returnValue *SoftLayer_Provisioning_Version1_Transaction
	return returnValue, nil
}
