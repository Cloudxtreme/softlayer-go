...
func (softlayer_security_ssh_key *SoftLayer_Security_Ssh_Key) CreateObject(templateObject SoftLayer_Security_Ssh_Key) (*SoftLayer_Security_Ssh_Key, error) {
	var returnValue *SoftLayer_Security_Ssh_Key
	return returnValue, nil
}

// DeleteObject - no documentation
func (softlayer_security_ssh_key *SoftLayer_Security_Ssh_Key) DeleteObject() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// EditObject - no documentation
func (softlayer_security_ssh_key *SoftLayer_Security_Ssh_Key) EditObject(templateObject SoftLayer_Security_Ssh_Key) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_security_ssh_key *SoftLayer_Security_Ssh_Key) GetObject() (*SoftLayer_Security_Ssh_Key, error) {
	var returnValue *SoftLayer_Security_Ssh_Key
	return returnValue, nil
}
