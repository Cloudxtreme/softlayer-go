...
func (softlayer_hardware *SoftLayer_Hardware) AllowAccessToNetworkStorage(networkStorageTemplateObject SoftLayer_Network_Storage) (bool, error) {
...
func (softlayer_hardware *SoftLayer_Hardware) AllowAccessToNetworkStorageList(networkStorageTemplateObjects []SoftLayer_Network_Storage) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_hardware *SoftLayer_Hardware) CaptureImage(captureTemplate SoftLayer_Container_Disk_Image_Capture_Template) (*SoftLayer_Virtual_Guest_Block_Device_Template_Group, error) {
	var returnValue *SoftLayer_Virtual_Guest_Block_Device_Template_Group
	return returnValue, nil
}

// CloseAlarm - no documentation
func (softlayer_hardware *SoftLayer_Hardware) CloseAlarm(alarmId string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_hardware *SoftLayer_Hardware) CreateObject(templateObject SoftLayer_Hardware) (*SoftLayer_Hardware, error) {
...
func (softlayer_hardware *SoftLayer_Hardware) DeleteObject() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// DeleteSoftwareComponentPasswords - no documentation
func (softlayer_hardware *SoftLayer_Hardware) DeleteSoftwareComponentPasswords(softwareComponentPasswords []SoftLayer_Software_Component_Password) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_hardware *SoftLayer_Hardware) EditSoftwareComponentPasswords(softwareComponentPasswords []SoftLayer_Software_Component_Password) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_hardware *SoftLayer_Hardware) FindByIpAddress(ipAddress string) (*SoftLayer_Hardware, error) {
	var returnValue *SoftLayer_Hardware
	return returnValue, nil
}
...
// object parameter.
func (softlayer_hardware *SoftLayer_Hardware) GenerateOrderTemplate(templateObject SoftLayer_Hardware) (*SoftLayer_Container_Product_Order, error) {
...
// entered.
func (softlayer_hardware *SoftLayer_Hardware) GetAlarmHistory(startDate time.Time, endDate time.Time, alarmId string) ([]*SoftLayer_Container_Monitoring_Alarm_History, error) {
...
func (softlayer_hardware *SoftLayer_Hardware) GetAttachedNetworkStorages(nasType string) ([]*SoftLayer_Network_Storage, error) {
...
func (softlayer_hardware *SoftLayer_Hardware) GetAvailableNetworkStorages(nasType string) ([]*SoftLayer_Network_Storage, error) {
	var returnValue []*SoftLayer_Network_Storage
	return returnValue, nil
}
...
// gigabytes.
func (softlayer_hardware *SoftLayer_Hardware) GetBackendIncomingBandwidth(startDate time.Time, endDate time.Time) (float32, error) {
...
// the time is ignored and defaults to midnight. The amount of bandwidth retrieved is measured in
// gigabytes.
func (softlayer_hardware *SoftLayer_Hardware) GetBackendOutgoingBandwidth(startDate time.Time, endDate time.Time) (float32, error) {
	var returnValue float32
	return returnValue, nil
}
...
func (softlayer_hardware *SoftLayer_Hardware) GetCreateObjectOptions() (*SoftLayer_Container_Hardware_Configuration, error) {
...
func (softlayer_hardware *SoftLayer_Hardware) GetCurrentBillingDetail() ([]*SoftLayer_Billing_Item, error) {
...
// hardware.
func (softlayer_hardware *SoftLayer_Hardware) GetCurrentBillingTotal() (float64, error) {
...
func (softlayer_hardware *SoftLayer_Hardware) GetDailyAverage(startDate time.Time, endDate time.Time) (float32, error) {
	var returnValue float32
	return returnValue, nil
}
...
func (softlayer_hardware *SoftLayer_Hardware) GetFrontendIncomingBandwidth(startDate time.Time, endDate time.Time) (float32, error) {
	var returnValue float32
	return returnValue, nil
}
...
func (softlayer_hardware *SoftLayer_Hardware) GetFrontendOutgoingBandwidth(startDate time.Time, endDate time.Time) (float32, error) {
	var returnValue float32
	return returnValue, nil
}
...
func (softlayer_hardware *SoftLayer_Hardware) GetHourlyBandwidth(mode string, day time.Time) ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
...
func (softlayer_hardware *SoftLayer_Hardware) GetMonitoringActiveAlarms(startDate time.Time, endDate time.Time) ([]*SoftLayer_Container_Monitoring_Alarm_History, error) {
	var returnValue []*SoftLayer_Container_Monitoring_Alarm_History
	return returnValue, nil
}

// GetMonitoringClosedAlarms - Returns closed monitoring alarms for a given time period
func (softlayer_hardware *SoftLayer_Hardware) GetMonitoringClosedAlarms(startDate time.Time, endDate time.Time) ([]*SoftLayer_Container_Monitoring_Alarm_History, error) {
	var returnValue []*SoftLayer_Container_Monitoring_Alarm_History
	return returnValue, nil
}
...
func (softlayer_hardware *SoftLayer_Hardware) GetObject() (*SoftLayer_Hardware, error) {
	var returnValue *SoftLayer_Hardware
	return returnValue, nil
}
...
func (softlayer_hardware *SoftLayer_Hardware) GetPrivateBandwidthData(startTime int, endTime int) ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
	var returnValue []*SoftLayer_Metric_Tracking_Object_Data
	return returnValue, nil
}
...
// 827 pixels by 293 pixels.
func (softlayer_hardware *SoftLayer_Hardware) GetPublicBandwidthData(startTime int, endTime int) ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
	var returnValue []*SoftLayer_Metric_Tracking_Object_Data
	return returnValue, nil
}
...
// apart.
func (softlayer_hardware *SoftLayer_Hardware) GetSensorData() ([]*SoftLayer_Container_RemoteManagement_SensorReading, error) {
...
func (softlayer_hardware *SoftLayer_Hardware) GetSensorDataWithGraphs() (*SoftLayer_Container_RemoteManagement_SensorReadingsWithGraphs, error) {
...
func (softlayer_hardware *SoftLayer_Hardware) GetServerFanSpeedGraphs() ([]*SoftLayer_Container_RemoteManagement_Graphs_SensorSpeed, error) {
...
func (softlayer_hardware *SoftLayer_Hardware) GetServerPowerState() (string, error) {
...
func (softlayer_hardware *SoftLayer_Hardware) GetServerTemperatureGraphs() ([]*SoftLayer_Container_RemoteManagement_Graphs_SensorTemperature, error) {
...
func (softlayer_hardware *SoftLayer_Hardware) GetUpgradeItemPrices() ([]*SoftLayer_Product_Item_Price, error) {
...
func (softlayer_hardware *SoftLayer_Hardware) ImportVirtualHost() (*SoftLayer_Virtual_Host, error) {
...
func (softlayer_hardware *SoftLayer_Hardware) IsPingable() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// Ping - Issues a ping command to the server and returns the ping response.
func (softlayer_hardware *SoftLayer_Hardware) Ping() (string, error) {
	var returnValue string
	return returnValue, nil
}
...
func (softlayer_hardware *SoftLayer_Hardware) PowerCycle() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// PowerOff - This method will power off the server via the server's remote management card.
func (softlayer_hardware *SoftLayer_Hardware) PowerOff() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// powerOff powerCycle
func (softlayer_hardware *SoftLayer_Hardware) PowerOn() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// powerOff powerCycle
func (softlayer_hardware *SoftLayer_Hardware) RebootDefault() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_hardware *SoftLayer_Hardware) RebootHard() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_hardware *SoftLayer_Hardware) RebootSoft() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_hardware *SoftLayer_Hardware) RemoveAccessToNetworkStorage(networkStorageTemplateObject SoftLayer_Network_Storage) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// SoftLayer_Network_Storage volumes that support host- or network-level access control.
func (softlayer_hardware *SoftLayer_Hardware) RemoveAccessToNetworkStorageList(networkStorageTemplateObjects []SoftLayer_Network_Storage) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// SetTags - <nil>
func (softlayer_hardware *SoftLayer_Hardware) SetTags(tags string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
