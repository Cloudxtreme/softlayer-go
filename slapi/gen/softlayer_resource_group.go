...
// EditObject - <nil>
func (softlayer_resource_group *SoftLayer_Resource_Group) EditObject(templateObject SoftLayer_Resource_Group) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_resource_group *SoftLayer_Resource_Group) GetObject() (*SoftLayer_Resource_Group, error) {
