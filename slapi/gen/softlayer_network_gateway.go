...
func (softlayer_network_gateway *SoftLayer_Network_Gateway) BypassAllVlans() error {
	return nil
}
...
// progress.
func (softlayer_network_gateway *SoftLayer_Network_Gateway) BypassVlans(vlans []SoftLayer_Network_Gateway_Vlan) error {
	return nil
}
...
func (softlayer_network_gateway *SoftLayer_Network_Gateway) CreateObject(templateObject SoftLayer_Network_Gateway) (*SoftLayer_Network_Gateway, error) {
...
func (softlayer_network_gateway *SoftLayer_Network_Gateway) EditObject(templateObject SoftLayer_Network_Gateway) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_network_gateway *SoftLayer_Network_Gateway) GetObject() (*SoftLayer_Network_Gateway, error) {
	var returnValue *SoftLayer_Network_Gateway
	return returnValue, nil
}
...
// firewalled.
func (softlayer_network_gateway *SoftLayer_Network_Gateway) GetPossibleInsideVlans() ([]*SoftLayer_Network_Vlan, error) {
...
func (softlayer_network_gateway *SoftLayer_Network_Gateway) UnbypassAllVlans() error {
	return nil
}
...
func (softlayer_network_gateway *SoftLayer_Network_Gateway) UnbypassVlans(vlans []SoftLayer_Network_Gateway_Vlan) error {
	return nil
}
