...
func (softlayer_billing_invoice *SoftLayer_Billing_Invoice) EmailInvoices(options SoftLayer_Container_Billing_Invoice_Email) error {
	return nil
}
...
func (softlayer_billing_invoice *SoftLayer_Billing_Invoice) GetExcel() (string, error) {
...
func (softlayer_billing_invoice *SoftLayer_Billing_Invoice) GetObject() (*SoftLayer_Billing_Invoice, error) {
...
func (softlayer_billing_invoice *SoftLayer_Billing_Invoice) GetPdf() (string, error) {
	var returnValue string
	return returnValue, nil
}
...
func (softlayer_billing_invoice *SoftLayer_Billing_Invoice) GetPdfDetailed() (string, error) {
	var returnValue string
	return returnValue, nil
}

// GetPdfDetailedFilename - <nil>
func (softlayer_billing_invoice *SoftLayer_Billing_Invoice) GetPdfDetailedFilename() (string, error) {
	var returnValue string
	return returnValue, nil
}
...
func (softlayer_billing_invoice *SoftLayer_Billing_Invoice) GetPdfFileSize() (int, error) {
	var returnValue int
	return returnValue, nil
}

// GetPdfFilename - <nil>
func (softlayer_billing_invoice *SoftLayer_Billing_Invoice) GetPdfFilename() (string, error) {
	var returnValue string
	return returnValue, nil
}
...
func (softlayer_billing_invoice *SoftLayer_Billing_Invoice) GetPreliminaryExcel() (string, error) {
	var returnValue string
	return returnValue, nil
}
...
func (softlayer_billing_invoice *SoftLayer_Billing_Invoice) GetPreliminaryPdf() (string, error) {
	var returnValue string
	return returnValue, nil
}
...
func (softlayer_billing_invoice *SoftLayer_Billing_Invoice) GetPreliminaryPdfDetailed() (string, error) {
	var returnValue string
	return returnValue, nil
}

// GetXlsFilename - <nil>
func (softlayer_billing_invoice *SoftLayer_Billing_Invoice) GetXlsFilename() (string, error) {
	var returnValue string
	return returnValue, nil
}

// GetZeroFeeItemCounts - <nil>
func (softlayer_billing_invoice *SoftLayer_Billing_Invoice) GetZeroFeeItemCounts() ([]*SoftLayer_Container_Product_Item_Category_ZeroFee_Count, error) {
