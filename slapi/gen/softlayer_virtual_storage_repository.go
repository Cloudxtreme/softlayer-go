...
func (softlayer_virtual_storage_repository *SoftLayer_Virtual_Storage_Repository) GetArchiveDiskUsageRatePerGb() (float64, error) {
	var returnValue float64
	return returnValue, nil
}

// GetAverageUsageMetricDataByDate - Returns the average disk space usage for a storage repository.
func (softlayer_virtual_storage_repository *SoftLayer_Virtual_Storage_Repository) GetAverageUsageMetricDataByDate(startDateTime time.Time, endDateTime time.Time) (float32, error) {
	var returnValue float32
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_virtual_storage_repository *SoftLayer_Virtual_Storage_Repository) GetObject() (*SoftLayer_Virtual_Storage_Repository, error) {
...
// gigabyte.
func (softlayer_virtual_storage_repository *SoftLayer_Virtual_Storage_Repository) GetPublicImageDiskUsageRatePerGb() (float64, error) {
	var returnValue float64
	return returnValue, nil
}

// GetStorageLocations - no documentation
func (softlayer_virtual_storage_repository *SoftLayer_Virtual_Storage_Repository) GetStorageLocations() ([]*SoftLayer_Location, error) {
...
func (softlayer_virtual_storage_repository *SoftLayer_Virtual_Storage_Repository) GetUsageMetricDataByDate(startDateTime time.Time, endDateTime time.Time) ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
...
// parameters.
func (softlayer_virtual_storage_repository *SoftLayer_Virtual_Storage_Repository) GetUsageMetricImageByDate(startDateTime time.Time, endDateTime time.Time) (*SoftLayer_Container_Bandwidth_GraphOutputs, error) {
