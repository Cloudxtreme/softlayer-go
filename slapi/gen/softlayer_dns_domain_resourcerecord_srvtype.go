...
// associated with.
func (softlayer_dns_domain_resourcerecord_srvtype *SoftLayer_Dns_Domain_ResourceRecord_SrvType) CreateObject(templateObject SoftLayer_Dns_Domain_ResourceRecord_SrvType) (*SoftLayer_Dns_Domain_ResourceRecord_SrvType, error) {
...
func (softlayer_dns_domain_resourcerecord_srvtype *SoftLayer_Dns_Domain_ResourceRecord_SrvType) CreateObjects(templateObjects []SoftLayer_Dns_Domain_ResourceRecord) ([]*SoftLayer_Dns_Domain_ResourceRecord, error) {
...
func (softlayer_dns_domain_resourcerecord_srvtype *SoftLayer_Dns_Domain_ResourceRecord_SrvType) DeleteObject() (bool, error) {
...
// deletion or ''false'' if it was unable to remove a resource record.
func (softlayer_dns_domain_resourcerecord_srvtype *SoftLayer_Dns_Domain_ResourceRecord_SrvType) DeleteObjects(templateObjects []SoftLayer_Dns_Domain_ResourceRecord_SrvType) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_dns_domain_resourcerecord_srvtype *SoftLayer_Dns_Domain_ResourceRecord_SrvType) EditObject(templateObject SoftLayer_Dns_Domain_ResourceRecord_SrvType) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_dns_domain_resourcerecord_srvtype *SoftLayer_Dns_Domain_ResourceRecord_SrvType) EditObjects(templateObjects []SoftLayer_Dns_Domain_ResourceRecord_SrvType) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_dns_domain_resourcerecord_srvtype *SoftLayer_Dns_Domain_ResourceRecord_SrvType) GetObject() (*SoftLayer_Dns_Domain_ResourceRecord_SrvType, error) {
	var returnValue *SoftLayer_Dns_Domain_ResourceRecord_SrvType
	return returnValue, nil
}
