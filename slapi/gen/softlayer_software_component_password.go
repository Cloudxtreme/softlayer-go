...
func (softlayer_software_component_password *SoftLayer_Software_Component_Password) CreateObject(templateObject SoftLayer_Software_Component_Password) (*SoftLayer_Software_Component_Password, error) {
...
func (softlayer_software_component_password *SoftLayer_Software_Component_Password) CreateObjects(templateObjects []SoftLayer_Software_Component_Password) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// DeleteObject - no documentation
func (softlayer_software_component_password *SoftLayer_Software_Component_Password) DeleteObject() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// DeleteObjects - Delete more than one passwords from a software component.
func (softlayer_software_component_password *SoftLayer_Software_Component_Password) DeleteObjects(templateObjects []SoftLayer_Software_Component_Password) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// port, and notes.
func (softlayer_software_component_password *SoftLayer_Software_Component_Password) EditObject(templateObject SoftLayer_Software_Component_Password) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// EditObjects - Edit more than one password from a software component.
func (softlayer_software_component_password *SoftLayer_Software_Component_Password) EditObjects(templateObjects []SoftLayer_Software_Component_Password) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_software_component_password *SoftLayer_Software_Component_Password) GetObject() (*SoftLayer_Software_Component_Password, error) {
	var returnValue *SoftLayer_Software_Component_Password
	return returnValue, nil
}
