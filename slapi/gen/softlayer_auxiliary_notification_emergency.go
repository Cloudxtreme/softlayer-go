...
func (softlayer_auxiliary_notification_emergency *SoftLayer_Auxiliary_Notification_Emergency) GetAllObjects() ([]*SoftLayer_Auxiliary_Notification_Emergency, error) {
...
func (softlayer_auxiliary_notification_emergency *SoftLayer_Auxiliary_Notification_Emergency) GetCurrentNotifications() ([]*SoftLayer_Auxiliary_Notification_Emergency, error) {
	var returnValue []*SoftLayer_Auxiliary_Notification_Emergency
	return returnValue, nil
}
...
func (softlayer_auxiliary_notification_emergency *SoftLayer_Auxiliary_Notification_Emergency) GetObject() (*SoftLayer_Auxiliary_Notification_Emergency, error) {
	var returnValue *SoftLayer_Auxiliary_Notification_Emergency
	return returnValue, nil
}
