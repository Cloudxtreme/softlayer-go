...
func (softlayer_product_item_category *SoftLayer_Product_Item_Category) GetAdditionalProductsForCategory() ([]*SoftLayer_Product_Item, error) {
	var returnValue []*SoftLayer_Product_Item
	return returnValue, nil
}

// GetBandwidthCategories - <nil>
func (softlayer_product_item_category *SoftLayer_Product_Item_Category) GetBandwidthCategories() ([]*SoftLayer_Product_Item_Category, error) {
...
func (softlayer_product_item_category *SoftLayer_Product_Item_Category) GetComputingCategories(resetCache bool) ([]*SoftLayer_Product_Item_Category, error) {
	var returnValue []*SoftLayer_Product_Item_Category
	return returnValue, nil
}

// GetCustomUsageRatesCategories - <nil>
func (softlayer_product_item_category *SoftLayer_Product_Item_Category) GetCustomUsageRatesCategories() ([]*SoftLayer_Product_Item_Category, error) {
	var returnValue []*SoftLayer_Product_Item_Category
	return returnValue, nil
}
...
func (softlayer_product_item_category *SoftLayer_Product_Item_Category) GetObject() (*SoftLayer_Product_Item_Category, error) {
	var returnValue *SoftLayer_Product_Item_Category
	return returnValue, nil
}

// GetSoftwareCategories - <nil>
func (softlayer_product_item_category *SoftLayer_Product_Item_Category) GetSoftwareCategories() ([]*SoftLayer_Product_Item_Category, error) {
	var returnValue []*SoftLayer_Product_Item_Category
	return returnValue, nil
}

// GetSubnetCategories - <nil>
func (softlayer_product_item_category *SoftLayer_Product_Item_Category) GetSubnetCategories() ([]*SoftLayer_Product_Item_Category, error) {
	var returnValue []*SoftLayer_Product_Item_Category
	return returnValue, nil
}
...
// are also top level items in a service offering.
func (softlayer_product_item_category *SoftLayer_Product_Item_Category) GetTopLevelCategories(resetCache bool) ([]*SoftLayer_Product_Item_Category, error) {
	var returnValue []*SoftLayer_Product_Item_Category
	return returnValue, nil
}
...
func (softlayer_product_item_category *SoftLayer_Product_Item_Category) GetValidCancelableServiceItemCategories() ([]*SoftLayer_Product_Item_Category, error) {
	var returnValue []*SoftLayer_Product_Item_Category
	return returnValue, nil
}

// GetVlanCategories - <nil>
func (softlayer_product_item_category *SoftLayer_Product_Item_Category) GetVlanCategories() ([]*SoftLayer_Product_Item_Category, error) {
	var returnValue []*SoftLayer_Product_Item_Category
	return returnValue, nil
}
