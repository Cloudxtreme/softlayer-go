...
func (softlayer_notification_occurrence_event *SoftLayer_Notification_Occurrence_Event) AcknowledgeNotification() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetAllObjects - <nil>
func (softlayer_notification_occurrence_event *SoftLayer_Notification_Occurrence_Event) GetAllObjects() ([]*SoftLayer_Notification_Occurrence_Event, error) {
...
// identifier.
func (softlayer_notification_occurrence_event *SoftLayer_Notification_Occurrence_Event) GetAttachedFile(attachmentId int) (string, error) {
...
func (softlayer_notification_occurrence_event *SoftLayer_Notification_Occurrence_Event) GetImpactedAccountCount() (int, error) {
	var returnValue int
	return returnValue, nil
}
...
func (softlayer_notification_occurrence_event *SoftLayer_Notification_Occurrence_Event) GetImpactedDeviceCount() (int, error) {
	var returnValue int
	return returnValue, nil
}
...
func (softlayer_notification_occurrence_event *SoftLayer_Notification_Occurrence_Event) GetImpactedDevices() ([]*SoftLayer_Notification_Occurrence_Resource, error) {
	var returnValue []*SoftLayer_Notification_Occurrence_Resource
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_notification_occurrence_event *SoftLayer_Notification_Occurrence_Event) GetObject() (*SoftLayer_Notification_Occurrence_Event, error) {
	var returnValue *SoftLayer_Notification_Occurrence_Event
	return returnValue, nil
}
