...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) ActivatePrivatePort() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// ActivatePublicPort - no documentation
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) ActivatePublicPort() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) AllowAccessToNetworkStorage(networkStorageTemplateObject SoftLayer_Network_Storage) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) AllowAccessToNetworkStorageList(networkStorageTemplateObjects []SoftLayer_Network_Storage) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) AttachDiskImage(imageId int) (*SoftLayer_Provisioning_Version1_Transaction, error) {
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) CancelIsolationForDestructiveAction() error {
	return nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) CaptureImage(captureTemplate SoftLayer_Container_Disk_Image_Capture_Template) (*SoftLayer_Virtual_Guest_Block_Device_Template_Group, error) {
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) CheckHostDiskAvailability(diskCapacity int) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// CloseAlarm - no documentation
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) CloseAlarm(alarmId string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) ConfigureMetadataDisk() (*SoftLayer_Provisioning_Version1_Transaction, error) {
	var returnValue *SoftLayer_Provisioning_Version1_Transaction
	return returnValue, nil
}

// CreateArchiveTransaction - Create a transaction to archive a computing instance's block devices
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) CreateArchiveTransaction(groupName string, blockDevices []SoftLayer_Virtual_Guest_Block_Device, note string) (*SoftLayer_Provisioning_Version1_Transaction, error) {
	var returnValue *SoftLayer_Provisioning_Version1_Transaction
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) CreateObject(templateObject SoftLayer_Virtual_Guest) (*SoftLayer_Virtual_Guest, error) {
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) CreateObjects(templateObjects []SoftLayer_Virtual_Guest) ([]*SoftLayer_Virtual_Guest, error) {
	var returnValue []*SoftLayer_Virtual_Guest
	return returnValue, nil
}

// CreatePostSoftwareInstallTransaction - <nil>
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) CreatePostSoftwareInstallTransaction(data string, returnBoolean bool) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) DeleteObject() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) DetachDiskImage(imageId int) (*SoftLayer_Provisioning_Version1_Transaction, error) {
	var returnValue *SoftLayer_Provisioning_Version1_Transaction
	return returnValue, nil
}

// EditObject - no documentation
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) EditObject(templateObject SoftLayer_Virtual_Guest) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// ExecuteIderaBareMetalRestore - Reboot a guest into the Idera Bare Metal Restore image.
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) ExecuteIderaBareMetalRestore() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// ExecuteR1SoftBareMetalRestore - Reboot a guest into the R1Soft Bare Metal Restore image.
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) ExecuteR1SoftBareMetalRestore() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// ExecuteRescueLayer - no documentation
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) ExecuteRescueLayer() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) FindByIpAddress(ipAddress string) (*SoftLayer_Virtual_Guest, error) {
	var returnValue *SoftLayer_Virtual_Guest
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GenerateOrderTemplate(templateObject SoftLayer_Virtual_Guest) (*SoftLayer_Container_Product_Order, error) {
...
// OS reload
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetAdditionalRequiredPricesForOsReload(config SoftLayer_Container_Hardware_Server_Configuration) ([]*SoftLayer_Product_Item_Price, error) {
	var returnValue []*SoftLayer_Product_Item_Price
	return returnValue, nil
}

// GetAlarmHistory - no documentation
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetAlarmHistory(startDate time.Time, endDate time.Time, alarmId string) ([]*SoftLayer_Container_Monitoring_Alarm_History, error) {
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetAttachedNetworkStorages(nasType string) ([]*SoftLayer_Network_Storage, error) {
	var returnValue []*SoftLayer_Network_Storage
	return returnValue, nil
}

// GetAvailableBlockDevicePositions - <nil>
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetAvailableBlockDevicePositions() ([]string, error) {
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetAvailableNetworkStorages(nasType string) ([]*SoftLayer_Network_Storage, error) {
	var returnValue []*SoftLayer_Network_Storage
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetBandwidthDataByDate(startDateTime time.Time, endDateTime time.Time, networkType string) ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
...
// graphing systems.
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetBandwidthForDateRange(startDate time.Time, endDate time.Time) ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
	var returnValue []*SoftLayer_Metric_Tracking_Object_Data
	return returnValue, nil
}
...
// snapshot specified.
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetBandwidthImage(networkType string, snapshotRange string, dateSpecified time.Time) (*SoftLayer_Container_Bandwidth_GraphOutputs, error) {
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetBandwidthImageByDate(startDateTime time.Time, endDateTime time.Time, networkType string) (*SoftLayer_Container_Bandwidth_GraphOutputs, error) {
	var returnValue *SoftLayer_Container_Bandwidth_GraphOutputs
	return returnValue, nil
}
...
// computing instance.
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetBandwidthTotal(startDateTime time.Time, endDateTime time.Time, direction string, side string) (uint64, error) {
	var returnValue uint64
	return returnValue, nil
}

// GetBootOrder - <nil>
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetBootOrder() (string, error) {
	var returnValue string
	return returnValue, nil
}

// GetConsoleAccessLog - Gets the console access logs for a computing instance
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetConsoleAccessLog() ([]*SoftLayer_Network_Logging_Syslog, error) {
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetCoreRestrictedOperatingSystemPrice() (*SoftLayer_Product_Item_Price, error) {
	var returnValue *SoftLayer_Product_Item_Price
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetCpuMetricDataByDate(startDateTime time.Time, endDateTime time.Time, cpuIndexes []int) ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
	var returnValue []*SoftLayer_Metric_Tracking_Object_Data
	return returnValue, nil
}
...
// gather the correct input parameters for the generic graphing utility automatically based on the
// snapshot specified.
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetCpuMetricImage(snapshotRange string, dateSpecified time.Time) (*SoftLayer_Container_Bandwidth_GraphOutputs, error) {
	var returnValue *SoftLayer_Container_Bandwidth_GraphOutputs
	return returnValue, nil
}
...
// gather the correct input parameters for the generic graphing utility based on the date ranges
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetCpuMetricImageByDate(startDateTime time.Time, endDateTime time.Time, cpuIndexes []int) (*SoftLayer_Container_Bandwidth_GraphOutputs, error) {
	var returnValue *SoftLayer_Container_Bandwidth_GraphOutputs
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetCreateObjectOptions() (*SoftLayer_Container_Virtual_Guest_Configuration, error) {
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetCurrentBillingDetail() ([]*SoftLayer_Billing_Item, error) {
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetCurrentBillingTotal() (float64, error) {
	var returnValue float64
	return returnValue, nil
}

// GetCustomBandwidthDataByDate - no documentation
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetCustomBandwidthDataByDate(graphData SoftLayer_Container_Graph) (*SoftLayer_Container_Graph, error) {
	var returnValue *SoftLayer_Container_Graph
	return returnValue, nil
}

// GetCustomMetricDataByDate - no documentation
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetCustomMetricDataByDate(graphData SoftLayer_Container_Graph) (*SoftLayer_Container_Graph, error) {
	var returnValue *SoftLayer_Container_Graph
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetDataMinMax() ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
	var returnValue []*SoftLayer_Metric_Tracking_Object_Data
	return returnValue, nil
}

// GetDriveRetentionItemPrice - Return a drive retention SoftLayer_Item_Price object for a guest.
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetDriveRetentionItemPrice() (*SoftLayer_Product_Item_Price, error) {
	var returnValue *SoftLayer_Product_Item_Price
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetFirewallProtectableSubnets() ([]*SoftLayer_Network_Subnet, error) {
	var returnValue []*SoftLayer_Network_Subnet
	return returnValue, nil
}

// GetFirstAvailableBlockDevicePosition - <nil>
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetFirstAvailableBlockDevicePosition() (string, error) {
	var returnValue string
	return returnValue, nil
}

// GetIsoBootImage - <nil>
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetIsoBootImage() (*SoftLayer_Virtual_Disk_Image, error) {
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetItemPricesFromSoftwareDescriptions(softwareDescriptions []SoftLayer_Software_Description, includeTranslationsFlag bool, returnAllPricesFlag bool) ([]*SoftLayer_Product_Item, error) {
...
// computing instance.
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetMemoryMetricDataByDate(startDateTime time.Time, endDateTime time.Time) ([]*SoftLayer_Metric_Tracking_Object_Data, error) {
	var returnValue []*SoftLayer_Metric_Tracking_Object_Data
	return returnValue, nil
}
...
// gather the correct input parameters for the generic graphing utility automatically based on the
// snapshot specified.
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetMemoryMetricImage(snapshotRange string, dateSpecified time.Time) (*SoftLayer_Container_Bandwidth_GraphOutputs, error) {
	var returnValue *SoftLayer_Container_Bandwidth_GraphOutputs
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetMemoryMetricImageByDate(startDateTime time.Time, endDateTime time.Time) (*SoftLayer_Container_Bandwidth_GraphOutputs, error) {
	var returnValue *SoftLayer_Container_Bandwidth_GraphOutputs
	return returnValue, nil
}

// GetMonitoringActiveAlarms - Returns open monitoring alarms for a given time period
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetMonitoringActiveAlarms(startDate time.Time, endDate time.Time) ([]*SoftLayer_Container_Monitoring_Alarm_History, error) {
	var returnValue []*SoftLayer_Container_Monitoring_Alarm_History
	return returnValue, nil
}

// GetMonitoringClosedAlarms - Returns closed monitoring alarms for a given time period
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetMonitoringClosedAlarms(startDate time.Time, endDate time.Time) ([]*SoftLayer_Container_Monitoring_Alarm_History, error) {
	var returnValue []*SoftLayer_Container_Monitoring_Alarm_History
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetNetworkComponentFirewallProtectableIpAddresses() ([]*SoftLayer_Network_Subnet_IpAddress, error) {
	var returnValue []*SoftLayer_Network_Subnet_IpAddress
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetObject() (*SoftLayer_Virtual_Guest, error) {
	var returnValue *SoftLayer_Virtual_Guest
	return returnValue, nil
}
...
// which were returned.
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetOrderTemplate(billingType string, orderPrices []SoftLayer_Product_Item_Price) (*SoftLayer_Container_Product_Order, error) {
	var returnValue *SoftLayer_Container_Product_Order
	return returnValue, nil
}

// GetProvisionDate - <nil>
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetProvisionDate() (*time.Time, error) {
	var returnValue *time.Time
	return returnValue, nil
}

// GetRecentMetricData - no documentation
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetRecentMetricData(time uint) ([]*SoftLayer_Metric_Tracking_Object, error) {
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetRemoteMonitoringActiveAlarms(startDate time.Time, endDate time.Time) ([]*SoftLayer_Container_Monitoring_Alarm_History, error) {
	var returnValue []*SoftLayer_Container_Monitoring_Alarm_History
	return returnValue, nil
}
...
// indicates that it work from SoftLayer monitoring cluster. If a monitoring agent does not have the
// flag, it resides in your cloud instance.
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetRemoteMonitoringClosedAlarms(startDate time.Time, endDate time.Time) ([]*SoftLayer_Container_Monitoring_Alarm_History, error) {
	var returnValue []*SoftLayer_Container_Monitoring_Alarm_History
	return returnValue, nil
}

// GetReverseDomainRecords - Retrieve the reverse domain records associated with this server.
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetReverseDomainRecords() ([]*SoftLayer_Dns_Domain, error) {
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetUpgradeItemPrices(includeDowngradeItemPrices bool) ([]*SoftLayer_Product_Item_Price, error) {
	var returnValue []*SoftLayer_Product_Item_Price
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) GetValidBlockDeviceTemplateGroups(visibility string) ([]*SoftLayer_Virtual_Guest_Block_Device_Template_Group, error) {
	var returnValue []*SoftLayer_Virtual_Guest_Block_Device_Template_Group
	return returnValue, nil
}
...
// ping command.
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) IsBackendPingable() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// command.
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) IsPingable() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) IsolateInstanceForDestructiveAction() error {
	return nil
}

// MountIsoImage - <nil>
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) MountIsoImage(diskImageId int) (*SoftLayer_Provisioning_Version1_Transaction, error) {
	var returnValue *SoftLayer_Provisioning_Version1_Transaction
	return returnValue, nil
}

// Pause - no documentation
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) Pause() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// PowerCycle - no documentation
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) PowerCycle() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// PowerOff - no documentation
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) PowerOff() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// PowerOffSoft - no documentation
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) PowerOffSoft() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// PowerOn - no documentation
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) PowerOn() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// RebootDefault - no documentation
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) RebootDefault() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// RebootHard - no documentation
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) RebootHard() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// RebootSoft - Attempt to complete a soft reboot of a guest by shutting down the operating system.
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) RebootSoft() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// ReloadCurrentOperatingSystemConfiguration - no documentation
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) ReloadCurrentOperatingSystemConfiguration() (*SoftLayer_Provisioning_Version1_Transaction, error) {
	var returnValue *SoftLayer_Provisioning_Version1_Transaction
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) ReloadOperatingSystem(token string, config SoftLayer_Container_Hardware_Server_Configuration) (string, error) {
	var returnValue string
	return returnValue, nil
}
...
// volume that supports host- or network-level access control.
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) RemoveAccessToNetworkStorage(networkStorageTemplateObject SoftLayer_Network_Storage) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// SoftLayer_Network_Storage volumes that support host- or network-level access control.
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) RemoveAccessToNetworkStorageList(networkStorageTemplateObjects []SoftLayer_Network_Storage) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// Resume - no documentation
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) Resume() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) SetPrivateNetworkInterfaceSpeed(newSpeed int) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// values can only be 0 (Disconnect), 10, 100, or 1000. The new speed must be equal to or less than the
// max speed of the interface. It will take less than a minute to update the port speed.
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) SetPublicNetworkInterfaceSpeed(newSpeed int) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// SetTags - <nil>
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) SetTags(tags string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// SetUserMetadata - Sets the data that will be written to the configuration drive.
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) SetUserMetadata(metadata []string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// ShutdownPrivatePort - no documentation
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) ShutdownPrivatePort() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// ShutdownPublicPort - no documentation
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) ShutdownPublicPort() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// UnmountIsoImage - <nil>
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) UnmountIsoImage() (*SoftLayer_Provisioning_Version1_Transaction, error) {
	var returnValue *SoftLayer_Provisioning_Version1_Transaction
	return returnValue, nil
}

// ValidateImageTemplate - no documentation
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) ValidateImageTemplate(imageTemplateId int) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_virtual_guest *SoftLayer_Virtual_Guest) VerifyReloadOperatingSystem(config SoftLayer_Container_Hardware_Server_Configuration) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
