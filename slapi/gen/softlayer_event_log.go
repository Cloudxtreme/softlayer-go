...
func (softlayer_event_log *SoftLayer_Event_Log) GetAllEventNames(objectName string) ([]string, error) {
	var returnValue []string
	return returnValue, nil
}

// GetAllEventObjectNames - no documentation
func (softlayer_event_log *SoftLayer_Event_Log) GetAllEventObjectNames() ([]string, error) {
	var returnValue []string
	return returnValue, nil
}

// GetAllObjects - <nil>
func (softlayer_event_log *SoftLayer_Event_Log) GetAllObjects() ([]*SoftLayer_Event_Log, error) {
	var returnValue []*SoftLayer_Event_Log
	return returnValue, nil
}

// GetAllUserTypes - <nil>
func (softlayer_event_log *SoftLayer_Event_Log) GetAllUserTypes() ([]string, error) {
	var returnValue []string
	return returnValue, nil
}
