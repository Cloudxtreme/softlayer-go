...
func (softlayer_user_customer_status *SoftLayer_User_Customer_Status) GetAllObjects() ([]*SoftLayer_User_Customer_Status, error) {
...
// service.
func (softlayer_user_customer_status *SoftLayer_User_Customer_Status) GetObject() (*SoftLayer_User_Customer_Status, error) {
	var returnValue *SoftLayer_User_Customer_Status
	return returnValue, nil
}
