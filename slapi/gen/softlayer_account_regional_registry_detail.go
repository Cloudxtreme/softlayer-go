...
func (softlayer_account_regional_registry_detail *SoftLayer_Account_Regional_Registry_Detail) CreateObject(templateObject SoftLayer_Account_Regional_Registry_Detail) (*SoftLayer_Account_Regional_Registry_Detail, error) {
...
// object.
func (softlayer_account_regional_registry_detail *SoftLayer_Account_Regional_Registry_Detail) DeleteObject() (bool, error) {
...
func (softlayer_account_regional_registry_detail *SoftLayer_Account_Regional_Registry_Detail) EditObject(templateObject SoftLayer_Account_Regional_Registry_Detail) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_account_regional_registry_detail *SoftLayer_Account_Regional_Registry_Detail) GetObject() (*SoftLayer_Account_Regional_Registry_Detail, error) {
	var returnValue *SoftLayer_Account_Regional_Registry_Detail
	return returnValue, nil
}
...
func (softlayer_account_regional_registry_detail *SoftLayer_Account_Regional_Registry_Detail) UpdateReferencedRegistrations() (*SoftLayer_Container_Network_Subnet_Registration_TransactionDetails, error) {
