...
func (softlayer_utility_network *SoftLayer_Utility_Network) IsPingable(address string) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// NsLookup - A method used to return the nameserver information for a given address
func (softlayer_utility_network *SoftLayer_Utility_Network) NsLookup(address string, type_ string) (string, error) {
...
func (softlayer_utility_network *SoftLayer_Utility_Network) Ping(address string) (string, error) {
	var returnValue string
	return returnValue, nil
}
...
func (softlayer_utility_network *SoftLayer_Utility_Network) Traceroute(address string) (string, error) {
	var returnValue string
	return returnValue, nil
}
...
func (softlayer_utility_network *SoftLayer_Utility_Network) Whois(address string) (string, error) {
	var returnValue string
	return returnValue, nil
}
