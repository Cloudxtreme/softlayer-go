...
func (softlayer_network_firewall_accesscontrollist *SoftLayer_Network_Firewall_AccessControlList) GetObject() (*SoftLayer_Network_Firewall_AccessControlList, error) {
