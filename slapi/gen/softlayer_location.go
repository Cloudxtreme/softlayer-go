...
func (softlayer_location *SoftLayer_Location) GetAvailableObjectStorageDatacenters() ([]*SoftLayer_Location, error) {
...
func (softlayer_location *SoftLayer_Location) GetDatacenters() ([]*SoftLayer_Location, error) {
	var returnValue []*SoftLayer_Location
	return returnValue, nil
}

// GetDatacentersWithVirtualImageStoreServiceResourceRecord - <nil>
func (softlayer_location *SoftLayer_Location) GetDatacentersWithVirtualImageStoreServiceResourceRecord() ([]*SoftLayer_Location, error) {
	var returnValue []*SoftLayer_Location
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_location *SoftLayer_Location) GetObject() (*SoftLayer_Location, error) {
	var returnValue *SoftLayer_Location
	return returnValue, nil
}
...
func (softlayer_location *SoftLayer_Location) GetViewableDatacenters() ([]*SoftLayer_Location, error) {
	var returnValue []*SoftLayer_Location
	return returnValue, nil
}

// GetViewablePopsAndDataCenters - Retrieve all viewable pop and datacenter locations.
func (softlayer_location *SoftLayer_Location) GetViewablePopsAndDataCenters() ([]*SoftLayer_Location, error) {
	var returnValue []*SoftLayer_Location
	return returnValue, nil
}

// GetViewablepointOfPresence - no documentation
func (softlayer_location *SoftLayer_Location) GetViewablepointOfPresence() ([]*SoftLayer_Location, error) {
	var returnValue []*SoftLayer_Location
	return returnValue, nil
}

// GetpointOfPresence - no documentation
func (softlayer_location *SoftLayer_Location) GetpointOfPresence() ([]*SoftLayer_Location, error) {
	var returnValue []*SoftLayer_Location
	return returnValue, nil
}
