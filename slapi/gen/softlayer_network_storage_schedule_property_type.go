...
func (softlayer_network_storage_schedule_property_type *SoftLayer_Network_Storage_Schedule_Property_Type) GetAllObjects() ([]*SoftLayer_Network_Storage_Schedule_Property_Type, error) {
	var returnValue []*SoftLayer_Network_Storage_Schedule_Property_Type
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_network_storage_schedule_property_type *SoftLayer_Network_Storage_Schedule_Property_Type) GetObject() (*SoftLayer_Network_Storage_Schedule_Property_Type, error) {
	var returnValue *SoftLayer_Network_Storage_Schedule_Property_Type
	return returnValue, nil
}
