...
// GetAffiliates - <nil>
func (softlayer_catalyst_enrollment *SoftLayer_Catalyst_Enrollment) GetAffiliates() ([]*SoftLayer_Catalyst_Affiliate, error) {
	var returnValue []*SoftLayer_Catalyst_Affiliate
	return returnValue, nil
}

// GetCompanyTypes - <nil>
func (softlayer_catalyst_enrollment *SoftLayer_Catalyst_Enrollment) GetCompanyTypes() ([]*SoftLayer_Catalyst_Company_Type, error) {
	var returnValue []*SoftLayer_Catalyst_Company_Type
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_catalyst_enrollment *SoftLayer_Catalyst_Enrollment) GetObject() (*SoftLayer_Catalyst_Enrollment, error) {
	var returnValue *SoftLayer_Catalyst_Enrollment
	return returnValue, nil
}

// SelfEnrollNewAccount - <nil>
func (softlayer_catalyst_enrollment *SoftLayer_Catalyst_Enrollment) SelfEnrollNewAccount(accountTemplate SoftLayer_Account) (*SoftLayer_Account, error) {
