...
func (softlayer_network_loadbalancer_global_account *SoftLayer_Network_LoadBalancer_Global_Account) AddNsRecord() (bool, error) {
...
// host.
func (softlayer_network_loadbalancer_global_account *SoftLayer_Network_LoadBalancer_Global_Account) EditObject(templateObject SoftLayer_Network_LoadBalancer_Global_Account) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_network_loadbalancer_global_account *SoftLayer_Network_LoadBalancer_Global_Account) GetObject() (*SoftLayer_Network_LoadBalancer_Global_Account, error) {
...
func (softlayer_network_loadbalancer_global_account *SoftLayer_Network_LoadBalancer_Global_Account) RemoveNsRecord() (bool, error) {
	var returnValue bool
	return returnValue, nil
}
