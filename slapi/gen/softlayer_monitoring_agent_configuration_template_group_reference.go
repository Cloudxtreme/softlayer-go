...
func (softlayer_monitoring_agent_configuration_template_group_reference *SoftLayer_Monitoring_Agent_Configuration_Template_Group_Reference) CreateObjects(templateObjects []SoftLayer_Monitoring_Agent_Configuration_Template_Group_Reference) (bool, error) {
...
func (softlayer_monitoring_agent_configuration_template_group_reference *SoftLayer_Monitoring_Agent_Configuration_Template_Group_Reference) EditObject(templateObject SoftLayer_Monitoring_Agent_Configuration_Template_Group_Reference) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_monitoring_agent_configuration_template_group_reference *SoftLayer_Monitoring_Agent_Configuration_Template_Group_Reference) EditObjects(templateObjects []SoftLayer_Monitoring_Agent_Configuration_Template_Group_Reference) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// user.
func (softlayer_monitoring_agent_configuration_template_group_reference *SoftLayer_Monitoring_Agent_Configuration_Template_Group_Reference) GetAllObjects() ([]*SoftLayer_Monitoring_Agent_Configuration_Template_Group_Reference, error) {
	var returnValue []*SoftLayer_Monitoring_Agent_Configuration_Template_Group_Reference
	return returnValue, nil
}
...
func (softlayer_monitoring_agent_configuration_template_group_reference *SoftLayer_Monitoring_Agent_Configuration_Template_Group_Reference) GetObject() (*SoftLayer_Monitoring_Agent_Configuration_Template_Group_Reference, error) {
	var returnValue *SoftLayer_Monitoring_Agent_Configuration_Template_Group_Reference
	return returnValue, nil
}
