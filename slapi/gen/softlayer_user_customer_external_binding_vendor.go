...
// GetObject - <nil>
func (softlayer_user_customer_external_binding_vendor *SoftLayer_User_Customer_External_Binding_Vendor) GetObject() (*SoftLayer_User_Customer_External_Binding_Vendor, error) {
