...
func (softlayer_network_vlan_firewall *SoftLayer_Network_Vlan_Firewall) GetObject() (*SoftLayer_Network_Vlan_Firewall, error) {
...
func (softlayer_network_vlan_firewall *SoftLayer_Network_Vlan_Firewall) RestoreDefaults() (*SoftLayer_Provisioning_Version1_Transaction, error) {
...
func (softlayer_network_vlan_firewall *SoftLayer_Network_Vlan_Firewall) SetTags(tags string) (bool, error) {
...
func (softlayer_network_vlan_firewall *SoftLayer_Network_Vlan_Firewall) UpdateRouteBypass(bypass bool) (*SoftLayer_Provisioning_Version1_Transaction, error) {
	var returnValue *SoftLayer_Provisioning_Version1_Transaction
	return returnValue, nil
}
