...
func (softlayer_account_regional_registry_detail_property *SoftLayer_Account_Regional_Registry_Detail_Property) CreateObject(templateObject SoftLayer_Account_Regional_Registry_Detail_Property) (*SoftLayer_Account_Regional_Registry_Detail_Property, error) {
...
func (softlayer_account_regional_registry_detail_property *SoftLayer_Account_Regional_Registry_Detail_Property) CreateObjects(templateObjects []SoftLayer_Account_Regional_Registry_Detail_Property) ([]*SoftLayer_Account_Regional_Registry_Detail_Property, error) {
	var returnValue []*SoftLayer_Account_Regional_Registry_Detail_Property
	return returnValue, nil
}
...
func (softlayer_account_regional_registry_detail_property *SoftLayer_Account_Regional_Registry_Detail_Property) DeleteObject() (bool, error) {
...
func (softlayer_account_regional_registry_detail_property *SoftLayer_Account_Regional_Registry_Detail_Property) EditObject(templateObject SoftLayer_Account_Regional_Registry_Detail_Property) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// EditObjects - Edit multiple [[SoftLayer_Account_Regional_Registry_Detail_Property]] objects.
func (softlayer_account_regional_registry_detail_property *SoftLayer_Account_Regional_Registry_Detail_Property) EditObjects(templateObjects []SoftLayer_Account_Regional_Registry_Detail_Property) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_account_regional_registry_detail_property *SoftLayer_Account_Regional_Registry_Detail_Property) GetObject() (*SoftLayer_Account_Regional_Registry_Detail_Property, error) {
	var returnValue *SoftLayer_Account_Regional_Registry_Detail_Property
	return returnValue, nil
}
