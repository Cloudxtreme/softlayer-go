...
func (softlayer_monitoring_agent_configuration_template_group *SoftLayer_Monitoring_Agent_Configuration_Template_Group) CreateObject(templateObject SoftLayer_Monitoring_Agent_Configuration_Template_Group) (*SoftLayer_Monitoring_Agent_Configuration_Template_Group, error) {
	var returnValue *SoftLayer_Monitoring_Agent_Configuration_Template_Group
	return returnValue, nil
}

// DeleteObject - no documentation
func (softlayer_monitoring_agent_configuration_template_group *SoftLayer_Monitoring_Agent_Configuration_Template_Group) DeleteObject() (bool, error) {
...
func (softlayer_monitoring_agent_configuration_template_group *SoftLayer_Monitoring_Agent_Configuration_Template_Group) EditObject(templateObject SoftLayer_Monitoring_Agent_Configuration_Template_Group) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetAllObjects - <nil>
func (softlayer_monitoring_agent_configuration_template_group *SoftLayer_Monitoring_Agent_Configuration_Template_Group) GetAllObjects() ([]*SoftLayer_Monitoring_Agent_Configuration_Template_Group, error) {
	var returnValue []*SoftLayer_Monitoring_Agent_Configuration_Template_Group
	return returnValue, nil
}
...
func (softlayer_monitoring_agent_configuration_template_group *SoftLayer_Monitoring_Agent_Configuration_Template_Group) GetConfigurationGroups(packageId int) ([]*SoftLayer_Monitoring_Agent_Configuration_Template_Group, error) {
	var returnValue []*SoftLayer_Monitoring_Agent_Configuration_Template_Group
	return returnValue, nil
}
...
func (softlayer_monitoring_agent_configuration_template_group *SoftLayer_Monitoring_Agent_Configuration_Template_Group) GetObject() (*SoftLayer_Monitoring_Agent_Configuration_Template_Group, error) {
	var returnValue *SoftLayer_Monitoring_Agent_Configuration_Template_Group
	return returnValue, nil
}
