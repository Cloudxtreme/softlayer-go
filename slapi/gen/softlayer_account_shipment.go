...
func (softlayer_account_shipment *SoftLayer_Account_Shipment) EditObject(templateObject SoftLayer_Account_Shipment) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetAllCouriers - no documentation
func (softlayer_account_shipment *SoftLayer_Account_Shipment) GetAllCouriers() ([]*SoftLayer_Auxiliary_Shipping_Courier, error) {
	var returnValue []*SoftLayer_Auxiliary_Shipping_Courier
	return returnValue, nil
}

// GetAllCouriersByType - no documentation
func (softlayer_account_shipment *SoftLayer_Account_Shipment) GetAllCouriersByType(courierTypeKeyName string) ([]*SoftLayer_Auxiliary_Shipping_Courier, error) {
	var returnValue []*SoftLayer_Auxiliary_Shipping_Courier
	return returnValue, nil
}

// GetAllShipmentStatuses - no documentation
func (softlayer_account_shipment *SoftLayer_Account_Shipment) GetAllShipmentStatuses() ([]*SoftLayer_Account_Shipment_Status, error) {
	var returnValue []*SoftLayer_Account_Shipment_Status
	return returnValue, nil
}

// GetAllShipmentTypes - no documentation
func (softlayer_account_shipment *SoftLayer_Account_Shipment) GetAllShipmentTypes() ([]*SoftLayer_Account_Shipment_Type, error) {
	var returnValue []*SoftLayer_Account_Shipment_Type
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_account_shipment *SoftLayer_Account_Shipment) GetObject() (*SoftLayer_Account_Shipment, error) {
