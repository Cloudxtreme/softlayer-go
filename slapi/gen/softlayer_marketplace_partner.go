...
// GetAllObjects - <nil>
func (softlayer_marketplace_partner *SoftLayer_Marketplace_Partner) GetAllObjects() ([]*SoftLayer_Marketplace_Partner, error) {
	var returnValue []*SoftLayer_Marketplace_Partner
	return returnValue, nil
}

// GetAllPublishedPartners - <nil>
func (softlayer_marketplace_partner *SoftLayer_Marketplace_Partner) GetAllPublishedPartners(searchTerm string) ([]*SoftLayer_Marketplace_Partner, error) {
	var returnValue []*SoftLayer_Marketplace_Partner
	return returnValue, nil
}

// GetFeaturedPartners - <nil>
func (softlayer_marketplace_partner *SoftLayer_Marketplace_Partner) GetFeaturedPartners(non bool) ([]*SoftLayer_Marketplace_Partner, error) {
	var returnValue []*SoftLayer_Marketplace_Partner
	return returnValue, nil
}

// GetFile - <nil>
func (softlayer_marketplace_partner *SoftLayer_Marketplace_Partner) GetFile(name string) (*SoftLayer_Marketplace_Partner_File, error) {
	var returnValue *SoftLayer_Marketplace_Partner_File
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_marketplace_partner *SoftLayer_Marketplace_Partner) GetObject() (*SoftLayer_Marketplace_Partner, error) {
	var returnValue *SoftLayer_Marketplace_Partner
	return returnValue, nil
}

// GetPartnerByUrlIdentifier - <nil>
func (softlayer_marketplace_partner *SoftLayer_Marketplace_Partner) GetPartnerByUrlIdentifier(urlIdentifier string) (*SoftLayer_Marketplace_Partner, error) {
	var returnValue *SoftLayer_Marketplace_Partner
	return returnValue, nil
}
