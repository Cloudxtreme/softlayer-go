...
func (softlayer_dns_domain_resourcerecord *SoftLayer_Dns_Domain_ResourceRecord) CreateObject(templateObject SoftLayer_Dns_Domain_ResourceRecord) (*SoftLayer_Dns_Domain_ResourceRecord, error) {
...
func (softlayer_dns_domain_resourcerecord *SoftLayer_Dns_Domain_ResourceRecord) CreateObjects(templateObjects []SoftLayer_Dns_Domain_ResourceRecord) ([]*SoftLayer_Dns_Domain_ResourceRecord, error) {
	var returnValue []*SoftLayer_Dns_Domain_ResourceRecord
	return returnValue, nil
}
...
func (softlayer_dns_domain_resourcerecord *SoftLayer_Dns_Domain_ResourceRecord) DeleteObject() (bool, error) {
...
func (softlayer_dns_domain_resourcerecord *SoftLayer_Dns_Domain_ResourceRecord) DeleteObjects(templateObjects []SoftLayer_Dns_Domain_ResourceRecord) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_dns_domain_resourcerecord *SoftLayer_Dns_Domain_ResourceRecord) EditObject(templateObject SoftLayer_Dns_Domain_ResourceRecord) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// upon creation. ''createObjects'' returns Boolean ''true'' on successful creation or ''false'' if it
// was unable to create a resource record.
func (softlayer_dns_domain_resourcerecord *SoftLayer_Dns_Domain_ResourceRecord) EditObjects(templateObjects []SoftLayer_Dns_Domain_ResourceRecord) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
// SoftLayer account.
func (softlayer_dns_domain_resourcerecord *SoftLayer_Dns_Domain_ResourceRecord) GetObject() (*SoftLayer_Dns_Domain_ResourceRecord, error) {
	var returnValue *SoftLayer_Dns_Domain_ResourceRecord
	return returnValue, nil
}
