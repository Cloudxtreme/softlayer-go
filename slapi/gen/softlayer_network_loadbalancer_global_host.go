...
func (softlayer_network_loadbalancer_global_host *SoftLayer_Network_LoadBalancer_Global_Host) DeleteObject() (bool, error) {
...
func (softlayer_network_loadbalancer_global_host *SoftLayer_Network_LoadBalancer_Global_Host) GetObject() (*SoftLayer_Network_LoadBalancer_Global_Host, error) {
