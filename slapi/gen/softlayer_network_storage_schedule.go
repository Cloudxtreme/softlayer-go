...
func (softlayer_network_storage_schedule *SoftLayer_Network_Storage_Schedule) CreateObject(templateObject SoftLayer_Network_Storage_Schedule) (*SoftLayer_Network_Storage_Schedule, error) {
...
func (softlayer_network_storage_schedule *SoftLayer_Network_Storage_Schedule) DeleteObject() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// EditObject - no documentation
func (softlayer_network_storage_schedule *SoftLayer_Network_Storage_Schedule) EditObject(templateObject SoftLayer_Network_Storage_Schedule) (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// GetObject - <nil>
func (softlayer_network_storage_schedule *SoftLayer_Network_Storage_Schedule) GetObject() (*SoftLayer_Network_Storage_Schedule, error) {
	var returnValue *SoftLayer_Network_Storage_Schedule
	return returnValue, nil
}
