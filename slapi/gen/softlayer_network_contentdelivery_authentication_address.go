...
func (softlayer_network_contentdelivery_authentication_address *SoftLayer_Network_ContentDelivery_Authentication_Address) CreateObject(templateObject SoftLayer_Network_ContentDelivery_Authentication_Address) (*SoftLayer_Network_ContentDelivery_Authentication_Address, error) {
	var returnValue *SoftLayer_Network_ContentDelivery_Authentication_Address
	return returnValue, nil
}

// DeleteObject - no documentation
func (softlayer_network_contentdelivery_authentication_address *SoftLayer_Network_ContentDelivery_Authentication_Address) DeleteObject() (bool, error) {
	var returnValue bool
	return returnValue, nil
}

// EditObject - This method let you edit an authentication IP object by passing a modified object.
func (softlayer_network_contentdelivery_authentication_address *SoftLayer_Network_ContentDelivery_Authentication_Address) EditObject(templateObject SoftLayer_Network_ContentDelivery_Authentication_Address) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
...
func (softlayer_network_contentdelivery_authentication_address *SoftLayer_Network_ContentDelivery_Authentication_Address) GetObject() (*SoftLayer_Network_ContentDelivery_Authentication_Address, error) {
	var returnValue *SoftLayer_Network_ContentDelivery_Authentication_Address
	return returnValue, nil
}
...
func (softlayer_network_contentdelivery_authentication_address *SoftLayer_Network_ContentDelivery_Authentication_Address) RearrangeAuthenticationIp(cdnAccountId int, templateObjects []SoftLayer_Network_ContentDelivery_Authentication_Address) (bool, error) {
	var returnValue bool
	return returnValue, nil
}
